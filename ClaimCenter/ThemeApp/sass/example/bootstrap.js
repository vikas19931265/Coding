...
Ext.Loader.addClassPathMappings({
  "ThemeApp": "../../app",
  "Titanium": "../../packages/titanium/overrides",
...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "Titanium.layout.component.Dock": [],
  ...
  "Titanium.form.field.HtmlEditor": [],
  "Ext.fx.Easing": [],
  "Ext.ProgressBar": [],
  ...
  "Ext.util.Memento": [],
  "Titanium.container.ButtonGroup": [],
  ...
  "ThemeApp.view.Viewport": [],
  "Ext.layout.container.Auto": [],
  "Titanium.grid.RowEditor": [],
  "Ext.grid.locking.Lockable": [
    "Ext.grid.Lockable"
  ],
  "Ext.ux.TreePicker": [],
  "Ext.view.AbstractView": [],
  "Titanium.toolbar.Paging": [],
  "Ext.util.Region": [],
