...
class AcordIncidentMapper implements IIncidentMapper
{
  ...
  override function getVehicleIncident(claim:Claim, autoLossInfo:AutoLossInfo_Type) : VehicleIncident {
  ...
  private function getVehicleJurisdiction(autoLossInfo:AutoLossInfo_Type): Jurisdiction {
    var state = State.get(autoLossInfo.VehInfo.RegistrationStateProvCd)
    var country:Country = null;
    if(not autoLossInfo.VehInfo.Registrations.Empty) {
       var countryCode = autoLossInfo.VehInfo.Registrations.first().CountryCd
  ...
  override function getGenLiabilityIncident(claim:Claim, glLossInfo:LiabilityLossInfo_Type) : Incident {
  ...
  override function getPropertyIncident(claim:Claim, propLossInfo:PropertyLossInfo_Type) : PropertyIncident {
  ...
  override function getInjuryIncident(claim:Claim, injuryInfo:ClaimsInjuredInfo_Type) : InjuryIncident {
  ...
  override function getWorkCompIncident(claim:Claim, wcLossInfo:WorkCompLossInfo_Type) : InjuryIncident {
    var incident = claim.newIncident(InjuryIncident) as InjuryIncident
