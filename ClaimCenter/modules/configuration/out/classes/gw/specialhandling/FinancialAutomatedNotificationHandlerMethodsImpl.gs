...
uses gw.cc.specialhandling.typekey.FinancialThreshold
...
class FinancialAutomatedNotificationHandlerMethodsImpl extends AutomatedNotificationHandlerMethodsImpl {
  ...
  */
  ...
  override protected function createNotificationActivity(aClaim : Claim, emailResult : Email) {
    ...
    newActivity.Subject = displaykey.Web.Admin.AutomatedHandlerTrigger.CannotNotifyContactActivity.Subject(Handler.EmailRole)    
    newActivity.Description = displaykey.Web.Admin.AutomatedHandlerTrigger.FinancialThreshold.CannotNotifyContactActivity.Description(
            Handler.EmailRole, 
