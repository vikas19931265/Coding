...
class CatastropheHeatMapViews {
  ...
  class AmountColorMap extends RangeColorMap {
    ...
    override function formatAmount(value : int) : String {
      return displaykey.JSP.ClaimSearch.Search.ClaimSearch.Catastrophe.LegendAmount(value)
    }
  ...
  public final var ClaimCountsView : CatastropheHeatMapView = new CatastropheHeatMapView() { 
    override property get FilterOptionLabel() : String { return displaykey.JSP.ClaimSearch.Search.ClaimSearch.Catastrophe.Claims }
    override property get LegendTitle() : String { return displaykey.JSP.ClaimSearch.Search.ClaimSearch.Catastrophe.NumberOfClaims }
    override property get SelectionMessage() : String {
      var count = HeatMap.ClaimsDataSet.CountOfPointsSelected
      return count == 1 ? displaykey.JSP.ClaimSearch.Search.ClaimSearch.Catastrophe.NumClaimsSelectedS(count)
                        : displaykey.JSP.ClaimSearch.Search.ClaimSearch.Catastrophe.NumClaimsSelectedP(count)
    }
  ...
  public final var ClaimTotalView : CatastropheHeatMapView = new CatastropheHeatMapView() { 
    override property get FilterOptionLabel() : String { return displaykey.JSP.ClaimSearch.Search.ClaimSearch.Catastrophe.ClaimTotalIncurred }
    override property get LegendTitle() : String { return displaykey.JSP.ClaimSearch.Search.ClaimSearch.Catastrophe.TotalIncurred }
    override property get SelectionMessage() : String { 
      ...
      var count = HeatMap.ClaimsDataSet.CountOfPointsSelected
      return count == 1 ? displaykey.JSP.ClaimSearch.Search.ClaimSearch.Catastrophe.NumClaimsSelectedWithIncurredS(count, totalIncurred)
                        : displaykey.JSP.ClaimSearch.Search.ClaimSearch.Catastrophe.NumClaimsSelectedWithIncurredP(count, totalIncurred)
    }
    override function setParms() { 
      HeatMap.DataSets = { HeatMap.ClaimsDataSet }
  ...
  public final var ClaimCountsWithPoliciesView : CatastropheHeatMapView = new CatastropheHeatMapView() { 
    override property get FilterOptionLabel() : String { return displaykey.JSP.ClaimSearch.Search.ClaimSearch.Catastrophe.ClaimsAndPolicyLocations }
    override property get LegendTitle() : String { return displaykey.JSP.ClaimSearch.Search.ClaimSearch.Catastrophe.NumberOfClaims }
     override property get Legend2Title() : String { return displaykey.JSP.ClaimSearch.Search.ClaimSearch.Catastrophe.PolicyLocations }
    override property get SelectionMessage() : String { 
      var clCount = HeatMap.ClaimsDataSet.CountOfPointsSelected
      var plCount = HeatMap.PolicyLocationDataSet.CountOfPointsSelected
      if (clCount == 1) {
        return plCount == 1 ? displaykey.JSP.ClaimSearch.Search.ClaimSearch.Catastrophe.NumClaimsAndPoliciesSelectedSS(clCount, plCount)
                            : displaykey.JSP.ClaimSearch.Search.ClaimSearch.Catastrophe.NumClaimsAndPoliciesSelectedSP(clCount, plCount)
      } else {
        return plCount == 1 ? displaykey.JSP.ClaimSearch.Search.ClaimSearch.Catastrophe.NumClaimsAndPoliciesSelectedPS(clCount, plCount)
                            : displaykey.JSP.ClaimSearch.Search.ClaimSearch.Catastrophe.NumClaimsAndPoliciesSelectedPP(clCount, plCount)
      }
    }
    override function setParms() { 
  ...
  public final var PolicyCountsView : CatastropheHeatMapView = new CatastropheHeatMapView() {
    override property get FilterOptionLabel() : String { return displaykey.JSP.ClaimSearch.Search.ClaimSearch.Catastrophe.PolicyLocations }
    override property get LegendTitle() : String { return displaykey.JSP.ClaimSearch.Search.ClaimSearch.Catastrophe.NumberOfPolicies }
    override property get SelectionMessage() : String { 
      var count = HeatMap.PolicyLocationDataSet.CountOfPointsSelected
      return count == 1 ? displaykey.JSP.ClaimSearch.Search.ClaimSearch.Catastrophe.NumPoliciesSelectedS(count)
                        : displaykey.JSP.ClaimSearch.Search.ClaimSearch.Catastrophe.NumPoliciesSelectedP(count)
    }
    override function setParms() { 
  ...
  public final var PolicyTotalView : CatastropheHeatMapView = new CatastropheHeatMapView() {
    override property get FilterOptionLabel() : String { return displaykey.JSP.ClaimSearch.Search.ClaimSearch.Catastrophe.TotalInsuredValue }
    override property get LegendTitle() : String { return displaykey.JSP.ClaimSearch.Search.ClaimSearch.Catastrophe.TotalInsured }
    override property get SelectionMessage() : String { 
      ...
      var count = HeatMap.PolicyLocationDataSet.CountOfPointsSelected
      return count == 1 ? displaykey.JSP.ClaimSearch.Search.ClaimSearch.Catastrophe.NumPoliciesSelectedWithInsuredS(count, totalInsured)
                        : displaykey.JSP.ClaimSearch.Search.ClaimSearch.Catastrophe.NumPoliciesSelectedWithInsuredP(count, totalInsured)
    }
    override function setParms() { 
      HeatMap.DataSets = { HeatMap.PolicyLocationDataSet }
