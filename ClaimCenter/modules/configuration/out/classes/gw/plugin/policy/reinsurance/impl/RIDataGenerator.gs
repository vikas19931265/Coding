...
class RIDataGenerator
{
  ...
  var _dataMap : Multimap<Pair<String, CoverageType>, DataBuilder<RIAgreement, ? extends RIAgreementBuilder>>

  construct() {
    _dataMap = HashMultimap.create<Pair<String, CoverageType>, DataBuilder<RIAgreement, ? extends RIAgreementBuilder>>()
    loadDemoData()
  }
  ...
  function getBuildersForPolicy(policyNumber:String, coverageType:CoverageType) : Collection<DataBuilder<RIAgreement, ? extends RIAgreementBuilder>> {
