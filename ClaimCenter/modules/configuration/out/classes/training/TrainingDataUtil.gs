...
class TrainingDataUtil {
  ...
  static function loadTrainingData() : void {
    ...
    var AndyApplegate = find (a in Credential where a.UserName == "aapplegate").FirstResult
    var Student01 = find (a in Credential where a.UserName == "student01").FirstResult
      ...
      if (Student01 != null) {
        ...
        */
        ...
        gw.transaction.Transaction.runWithNewBundle(\ newBundle -> {
          ...
          //   useradminUserContact.PrimaryAddress = primaryAddress2
          useradminUserContact.PrimaryPhone = "work"
          ...
          //   csrUserContact.PrimaryAddress = primaryAddress
          csrUserContact.PrimaryPhone = "work"
          ...
          useradminUserSettings.StartupPage = "DesktopActivities"

          var csrUserSettings = new UserSettings()
          csrUserSettings.StartupPage = "ClaimSearch"
        ...
        for (x in 1..21) {
          ...
          gw.transaction.Transaction.runWithNewBundle(\ newBundle -> {
            ...
            //          studentUserContact.PrimaryAddress = primaryAddress3
            studentUserContact.PrimaryPhone = "work"
            ...
            //       coworkerUserContact.PrimaryAddress = primaryAddress4
            coworkerUserContact.PrimaryPhone = "work"
            ...
            //          supervisorUserContact.PrimaryAddress = primaryAddress5
            supervisorUserContact.PrimaryPhone = "work"
            ...
            studentUserSettings.StartupPage = "DesktopActivities"

            var coworkerUserSettings = new UserSettings()
            coworkerUserSettings.StartupPage = "DesktopActivities"

            var supervisorUserSettings = new UserSettings()
            supervisorUserSettings.StartupPage = "DesktopActivities"
