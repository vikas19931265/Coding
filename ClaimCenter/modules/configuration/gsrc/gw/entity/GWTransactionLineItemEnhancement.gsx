...
enhancement GWTransactionLineItemEnhancement : TransactionLineItem
{
  ...
  public function isDeductibleLineItem() : boolean {
    return (this.LineCategory == "Deductible") && (this.Transaction typeis Payment) && (this.Transaction.SharedDeductible.TransactionLineItem == this)
  }
  ...
  property get ValidLineCategories() : java.util.List<LineCategory> {
    var fullList = LineCategory.Type.getTypeKeysByCategories({this.Transaction.Exposure.PrimaryCoverage, this.Transaction.CostType, this.Transaction.CostCategory})
