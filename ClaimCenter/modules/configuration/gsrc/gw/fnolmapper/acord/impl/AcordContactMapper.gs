...
class AcordContactMapper implements IContactMapper
{
  ...
  private function getContact2(partyInfo:GeneralPartyInfo_Type, principalInfo:InsuredOrPrincipalInfo_Type) : Contact 
  {
  ...
  private function getLicenseState(driversLicense: xsd.acord.DriversLicense_Type) : Jurisdiction {
      ...
      return AddressJurisdictionHandler.getJurisdiction(new AddressFillableExtensionImpl() {
          :Country = country, :State = driversLicense.StateProvCd
      })
  }
}
