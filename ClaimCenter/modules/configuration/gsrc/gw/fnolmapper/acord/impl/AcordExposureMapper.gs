...
class AcordExposureMapper implements IExposureMapper
{
  ...
  override function getVehicleExposure(claim:Claim, autoLossInfo:AutoLossInfo_Type, incident:VehicleIncident) : Exposure {
  ...
  override function getGenLiabilityExposure(claim:Claim, glLossInfo:LiabilityLossInfo_Type, incident:Incident) : Exposure {
    var exposure:Exposure
  ...
  override function getPropertyExposure(claim:Claim, propLossInfo:PropertyLossInfo_Type, incident:PropertyIncident) : Exposure {
    var exposure:Exposure
  ...
  override function getWorkCompExposure(claim:Claim, wcLossInfo:WorkCompLossInfo_Type, incident:Incident) : Exposure {
    var exposure:Exposure
  ...
  override function getInjuryExposure(claim:Claim, injuryInfo:ClaimsInjuredInfo_Type, incident:InjuryIncident) : Exposure {
