package gw.webservice.cc.cc801
...
uses gw.webservice.cc.cc801.dto.IncidentDTO
 ...
 */
@WsiWebService("http://guidewire.com/cc/ws/gw/webservice/cc/cc801/CCWsiEntityApiBase")
...
abstract class CCWsiEntityApiBase {
  ...
  protected function assembleFromDTOs(dtos : ActivityDTO[], claim : Claim, exposure : Exposure) : Activity[] {
    return dtos.map(\ dto -> {
      ...
      ArgCheck.nonBlank(dto.ActivityPatternID, "activityDTO.ActivityPatternID")
  ...
  protected function assembleFromDTO(claimDTO : ClaimDTO, policyDTO : PolicyDTO, bundle : Bundle) : Claim {
    ...
    if (policyDTO != null) {
      claim.Policy = policyDTO.writeToNewEntityIn(bundle)
    }
   ...
   */
  protected function fetchByID<U extends KeyableBean>(publicID : String) : U {
    return fetchByID<U>(publicID, null)
  }
   ...
   */
  protected function fetchByID<U extends KeyableBean>(publicID : String, bundle : Bundle) : U {
    var entity : U
    ...
    return bundle == null ? entity : bundle.add(entity)
  }
   ...
   * @param bundle The bundle to which to add the fetched object
   */
  protected function fetchByID<U extends KeyableBean>(publicIDs : String[]) : Iterator<U> {
