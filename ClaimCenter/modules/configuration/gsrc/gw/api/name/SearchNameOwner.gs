...
class SearchNameOwner extends NameOwnerBase {
  ...
  override property get ContactNameLabel() : String {
    switch (NameLabelType) {
      case PAYEE: return displaykey.JSP.PaymentSearch.Payments.CompanyName
      case PAYER: return displaykey.JSP.RecoverySearch.Recoveries.CompanyName
      default:    return displaykey.JSP.ClaimSearch.Claims.CompanyName
    }
  }

  override property get ContactNamePhoneticLabel() : String {
    switch (NameLabelType) {
      case PAYEE: return displaykey.JSP.PaymentSearch.Payments.CompanyNamePhonetic
      case PAYER: return displaykey.JSP.RecoverySearch.Recoveries.CompanyNamePhonetic
      default:    return displaykey.JSP.ClaimSearch.Claims.CompanyNamePhonetic
    }
  }

  override property get FirstNameLabel() : String {
    switch (NameLabelType) {
      case PAYEE: return displaykey.JSP.PaymentSearch.Payments.FirstName
      case PAYER: return displaykey.JSP.RecoverySearch.Recoveries.FirstName
  ...
  override property get FirstNamePhoneticLabel() : String {
    switch (NameLabelType) {
      case PAYEE: return displaykey.JSP.PaymentSearch.Payments.FirstNamePhonetic
      case PAYER: return displaykey.JSP.RecoverySearch.Recoveries.FirstNamePhonetic
  ...
  override property get LastNameLabel() : String {
    switch (NameLabelType) {
      case PAYEE: return displaykey.JSP.PaymentSearch.Payments.LastName
      case PAYER: return displaykey.JSP.RecoverySearch.Recoveries.LastName
  ...
  override property get LastNamePhoneticLabel() : String {
    switch (NameLabelType) {
      case PAYEE: return displaykey.JSP.PaymentSearch.Payments.LastNamePhonetic
      case PAYER: return displaykey.JSP.RecoverySearch.Recoveries.LastNamePhonetic
