...
class ClaimSpecialHandlingMethodsImpl implements ClaimSpecialHandlingMethods {
  ...
  override property get AutomatedHandlers() : AutomatedHandler[] {
    ...
    if (null != policyAccount and null != policyAccount.SpecialHandling) {
      handlers.addAll(policyAccount.SpecialHandling.AutomatedHandlers.where(\ o -> o.PolicyType== null or o.PolicyType == policyType) as java.util.Collection<AutomatedHandler>)
    }
    ...
    if (null != specialHandling and null != serviceTier) {
      handlers.addAll(specialHandling.AutomatedHandlers.where(\ o -> o.PolicyType== null or o.PolicyType == policyType) as java.util.Collection<AutomatedHandler>)
    }
  ...
  override property get OtherInstructions() : OtherInstruction[] {
    ...
    var policyAccount = policy.PolicyAccount
    if (null != policyAccount and null != policyAccount.SpecialHandling) {
      instructions.addAll(policyAccount.SpecialHandling.OtherInstructions.where(\ o -> o.PolicyType== null or o.PolicyType == policyType) as java.util.Collection<OtherInstruction>)
    }
    ...
    if (null != CustomerServiceTier and null != specialHandling) {
        ...
        instructions.addAll(specialHandling.OtherInstructions.where(\ o -> o.PolicyType== null or o.PolicyType == policyType) as java.util.Collection<OtherInstruction>)
    }
