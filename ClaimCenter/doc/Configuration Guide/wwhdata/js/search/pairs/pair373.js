...
x.t("claimcontactrole","adds");
x.t("example","create");
x.t("example","contactrole");
x.t("example","extend");
...
x.t("file","entityroleconstraints-config.xml");
x.t("list","contacts");
x.t("menu","gosu");
x.t("add","required");
x.t("add","exclusive");
...
x.t("manipulate","gather");
x.t("manipulate","array\u2019s");
x.t("subobjects","getcontactsexcluderole");
x.t("subobjects","getcontactsbyroles");
x.t("subobjects","getcontactsexcluderoles");
x.t("subobjects","getcontacttype");
...
x.t("entityroleconstraints-config.xml","configures");
