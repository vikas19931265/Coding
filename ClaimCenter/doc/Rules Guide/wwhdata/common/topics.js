...
else if (Guidewire_TopicMatch(TOPIC,"Guidewire ClaimCenter\u00ae") && Guidewire_FMSourceFileMatch(SRCFILE,"cover-rules.html") ) { return "cover-rules.html";}
...
else if (Guidewire_TopicMatch(TOPIC,"Approval Routing Rule Set Category") && Guidewire_FMSourceFileMatch(SRCFILE,"cc_rulesets.09.03.html") ) { return "cc_rulesets.09.03.html";}
else if (Guidewire_TopicMatch(TOPIC,"Archive Rule Set Category") && Guidewire_FMSourceFileMatch(SRCFILE,"cc_rulesets.09.04.html") ) { return "cc_rulesets.09.04.html";}
else if (Guidewire_TopicMatch(TOPIC,"Assignment Rule Set Category") && Guidewire_FMSourceFileMatch(SRCFILE,"cc_rulesets.09.05.html") ) { return "cc_rulesets.09.05.html";}
else if (Guidewire_TopicMatch(TOPIC,"BulkInvoice Approval Rule Set Category") && Guidewire_FMSourceFileMatch(SRCFILE,"cc_rulesets.09.06.html") ) { return "cc_rulesets.09.06.html";}
else if (Guidewire_TopicMatch(TOPIC,"Closed Rule Set Category") && Guidewire_FMSourceFileMatch(SRCFILE,"cc_rulesets.09.07.html") ) { return "cc_rulesets.09.07.html";}
else if (Guidewire_TopicMatch(TOPIC,"Event Message Rule Set Category") && Guidewire_FMSourceFileMatch(SRCFILE,"cc_rulesets.09.08.html") ) { return "cc_rulesets.09.08.html";}
else if (Guidewire_TopicMatch(TOPIC,"Exception Rule Set Category") && Guidewire_FMSourceFileMatch(SRCFILE,"cc_rulesets.09.09.html") ) { return "cc_rulesets.09.09.html";}
else if (Guidewire_TopicMatch(TOPIC,"Initial Reserve Rule Set Category") && Guidewire_FMSourceFileMatch(SRCFILE,"cc_rulesets.09.10.html") ) { return "cc_rulesets.09.10.html";}
else if (Guidewire_TopicMatch(TOPIC,"Loaded Rule Set Category") && Guidewire_FMSourceFileMatch(SRCFILE,"cc_rulesets.09.11.html") ) { return "cc_rulesets.09.11.html";}
else if (Guidewire_TopicMatch(TOPIC,"Postsetup Rule Set Category") && Guidewire_FMSourceFileMatch(SRCFILE,"cc_rulesets.09.12.html") ) { return "cc_rulesets.09.12.html";}
else if (Guidewire_TopicMatch(TOPIC,"Presetup Rule Set Category") && Guidewire_FMSourceFileMatch(SRCFILE,"cc_rulesets.09.13.html") ) { return "cc_rulesets.09.13.html";}
else if (Guidewire_TopicMatch(TOPIC,"Preupdate Rule Set Category") && Guidewire_FMSourceFileMatch(SRCFILE,"cc_rulesets.09.14.html") ) { return "cc_rulesets.09.14.html";}
else if (Guidewire_TopicMatch(TOPIC,"Reopened Rule Set Category") && Guidewire_FMSourceFileMatch(SRCFILE,"cc_rulesets.09.15.html") ) { return "cc_rulesets.09.15.html";}
else if (Guidewire_TopicMatch(TOPIC,"Segmentation Rule Set Category") && Guidewire_FMSourceFileMatch(SRCFILE,"cc_rulesets.09.16.html") ) { return "cc_rulesets.09.16.html";}
else if (Guidewire_TopicMatch(TOPIC,"Transaction Approval Rule Set Category") && Guidewire_FMSourceFileMatch(SRCFILE,"cc_rulesets.09.17.html") ) { return "cc_rulesets.09.17.html";}
else if (Guidewire_TopicMatch(TOPIC,"Validation Rule Set Category") && Guidewire_FMSourceFileMatch(SRCFILE,"cc_rulesets.09.18.html") ) { return "cc_rulesets.09.18.html";}
else if (Guidewire_TopicMatch(TOPIC,"Adding New Validation Levels") && Guidewire_FMSourceFileMatch(SRCFILE,"cc_rulesets.09.19.html") ) { return "cc_rulesets.09.19.html";}
else if (Guidewire_TopicMatch(TOPIC,"Workplan Rule Set Category") && Guidewire_FMSourceFileMatch(SRCFILE,"cc_rulesets.09.20.html") ) { return "cc_rulesets.09.20.html";}
...
else if (Guidewire_TopicMatch(TOPIC,"Detecting Claim Fraud") && Guidewire_FMSourceFileMatch(SRCFILE,"rules_siu.14.1.html") ) { return "rules_siu.14.1.html";}
else if (Guidewire_TopicMatch(TOPIC,"Claim Fraud") && Guidewire_FMSourceFileMatch(SRCFILE,"rules_siu.14.2.html") ) { return "rules_siu.14.2.html";}
else if (Guidewire_TopicMatch(TOPIC,"The Special Investigation Details Screen") && Guidewire_FMSourceFileMatch(SRCFILE,"rules_siu.14.3.html") ) { return "rules_siu.14.3.html";}
else if (Guidewire_TopicMatch(TOPIC,"Special Investigation Trigger Rules") && Guidewire_FMSourceFileMatch(SRCFILE,"rules_siu.14.4.html") ) { return "rules_siu.14.4.html";}
else if (Guidewire_TopicMatch(TOPIC,"SI Rule Evaluation Sequence") && Guidewire_FMSourceFileMatch(SRCFILE,"rules_siu.14.5.html") ) { return "rules_siu.14.5.html";}
else if (Guidewire_TopicMatch(TOPIC,"Using the Special Investigation Rules") && Guidewire_FMSourceFileMatch(SRCFILE,"rules_siu.14.6.html") ) { return "rules_siu.14.6.html";}
...
else if (Guidewire_TopicMatch(TOPIC,"Guidewire ClaimCenter and Email") && Guidewire_FMSourceFileMatch(SRCFILE,"rules_sending_emails.15.02.html") ) { return "rules_sending_emails.15.02.html";}
...
else if (Guidewire_TopicMatch(TOPIC,"Configuring ClaimCenter to Send Emails") && Guidewire_FMSourceFileMatch(SRCFILE,"rules_sending_emails.15.10.html") ) { return "rules_sending_emails.15.10.html";}
...
else if (Guidewire_TopicMatch(TOPIC,"Integrating Document Functionality with ClaimCenter") && Guidewire_FMSourceFileMatch(SRCFILE,"rules_documentcreation.16.3.html") ) { return "rules_documentcreation.16.3.html";}
...
else if (Guidewire_TopicMatch(TOPIC,"Transaction Set Validation") && Guidewire_FMSourceFileMatch(SRCFILE,"transaction_validation.17.1.html") ) { return "transaction_validation.17.1.html";}
else if (Guidewire_TopicMatch(TOPIC,"Transaction Set Validation Rules") && Guidewire_FMSourceFileMatch(SRCFILE,"transaction_validation.17.2.html") ) { return "transaction_validation.17.2.html";}
else if (Guidewire_TopicMatch(TOPIC,"sumForPIPAgg Enhancement Methods") && Guidewire_FMSourceFileMatch(SRCFILE,"transaction_validation.17.3.html") ) { return "transaction_validation.17.3.html";}
else if (Guidewire_TopicMatch(TOPIC,"Working with Queues") && Guidewire_FMSourceFileMatch(SRCFILE,"queues.18.1.html") ) { return "queues.18.1.html";}
else if (Guidewire_TopicMatch(TOPIC,"What Are Activity Queues") && Guidewire_FMSourceFileMatch(SRCFILE,"queues.18.2.html") ) { return "queues.18.2.html";}
else if (Guidewire_TopicMatch(TOPIC,"Using a Queue to Handle FNOL Claims: Example") && Guidewire_FMSourceFileMatch(SRCFILE,"queues.18.3.html") ) { return "queues.18.3.html";}
else if (Guidewire_TopicMatch(TOPIC,"Using a Queue to VoidStop Checks: Example") && Guidewire_FMSourceFileMatch(SRCFILE,"queues.18.4.html") ) { return "queues.18.4.html";}
