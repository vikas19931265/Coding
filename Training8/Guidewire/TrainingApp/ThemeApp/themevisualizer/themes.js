...
function getStore () {
    // Reverse order data should get sorted by the MemoryProxy
     var myData = [
         ...
         ['Alcoa Inc',29.01,0.42,1.47,'9/1 12:00am', false, true],
...
function getCellEditorGrid() {
    ...
    var editableRenderer = function(value, metaData) {
        metaData.tdCls += ' x-grid-cell-editable'; // mark cell editable
        return value;
    };

    return applySizing('gridCellEditor', {
        xtype: 'grid',
        title: 'Cell Editable Grid',
        store: store,
        columns: [
            {
                header: 'Name',  
...
function getLeftNavigation() {
    return applySizing('leftNavigation', {
        xtype: 'panel',
        border: false,
        layout: 'anchor',
        defaults: {
...
function getInlineDetails() {
    return applySizing('inlineDetails', {
        xtype: 'panel',
        ui: 'inline-details',
        layout: {
            type: 'table',
        ...
        items: [{
            ...
            width: 80,
            padding: '0 0 15 0',
            html: '<div style="width: 64px; height: 64px; background: #CCC;"></div>'
        },{
            xtype: 'container',
            items: [{
                xtype: 'component',
                cls: 'inline-details-title',
                html: 'Personal Property'
            },{
                xtype: 'component',
                html: 'Pellentesque faucibus cursus sem eu interdum. Aliquam commodo pulvinar nibh et sodales. Donec molestie libero nec est malesuada et posuere sem gravida.'
            }]
        }]
    });
}
...
function getListDetails() {
    ...
    return applySizing('listDetails', {
        xtype: 'panel',
        ui: 'page',
        title: "Multiple Tabs",
        items: [{
    ...
    return applySizing('wizard', {
        ...
        items: [{
            ...
            items: [{
                ...
                value: 'Version 1.0',
                anchor: '0',
                store: ['Version 1.0', 'Version 2.0']
            },{
                xtype: 'combobox',
                value: 'Version Number: 1.0',
                anchor: '0',
                store: ['Version Number: 1.0', 'Version Number: 2.0']
            },{
                xtype: 'combobox',
                value: 'Version Number: 1.0',
                anchor: '0',
            ...
            manageHeight: false,
            useArrows: true,
            title: 'Sample Wizard- Test',
            store: Ext.create('Ext.data.TreeStore', {
                root: {
                    expanded: true,
                    children: [{ 
                        text: "Tour Group Info",
                        leaf: true
                    },{ 
                        text: "Add Tourists",
                        leaf: true
...
var sizing = {
    ...
    pagePanel: {
        classic: [150, 90, 20, 1460],
        neptune: [150, 130, 20, 1460]
    },
    progressBar: {
    ...
    buttons: {
        classic: [490, 430, 190, 1460],
        neptune: [490, 430, 190, 1460]
    },
    gridCellEditor: {
        classic: [500, 200, 690, 1520],
        neptune: [500, 200, 690, 1520]
    },
    leftNavigation: {
        classic: [150, 330, 20, 1610],
        neptune: [150, 330, 20, 1610]
    },
    inlineDetails: {
        classic: [300, 145, 200, 1800],
        neptune: [300, 145, 200, 1800]
    },
    listDetails: {
        classic: [500, 400, 690, 1820],
        neptune: [500, 400, 690, 1820]
    },
    wizard: {
        classic: [200, 430, 20, 1960],
        neptune: [200, 430, 20, 1960]
    }
};
