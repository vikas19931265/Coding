 ...
 */
@WsiWebService("http://guidewire.com/ab/ws/gw/webservice/ab/ab800/MessagingToolsAPI")
...
class MessagingToolsAPI {
  ...
  /**
   * This will restart the destination with the change to the configuration settings, note that this
