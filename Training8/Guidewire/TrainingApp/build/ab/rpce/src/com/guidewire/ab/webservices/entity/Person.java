 ...
 *         Person extends Contact with additional information about individuals
 * that is not applicable to companies or
 *         places.
 */
public class Person  extends com.guidewire.ab.webservices.entity.Contact  implements java.io.Serializable {
    /** 
 ...
 * null otherwise)
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://entity.webservices.ab.guidewire.com/", "Person"));
