 ...
 */
@Deprecated
public interface BusinessWeekZone extends com.guidewire.ab.external.entity.Versionable, gw.pl.external.entity.Entity
{
   ...
   * 
   */
  @gw.pl.external.Invocation(type = gw.pl.external.InvocationType.PROPERTY_GETTER, name = "BusinessWeek")
  public com.guidewire.ab.external.entity.BusinessWeek getBusinessWeek();

  /**
   * The businessweek.
   * 
   */
  @gw.pl.external.Invocation(type = gw.pl.external.InvocationType.PROPERTY_SETTER, name = "BusinessWeek")
  public void setBusinessWeek(com.guidewire.ab.external.entity.BusinessWeek value);


  /**
   * The code for this zone, this is the value that should be used for zone lookups. NOTE: when inserting a BusinessWeekZone this field must be non-null.
   * 
   */
  ...
  /**
   * Country of this zone. NOTE: when inserting a BusinessWeekZone this field must be non-null.
   * 
   */
  ...
  /**
   * Type of this zone. NOTE: when inserting a BusinessWeekZone this field must be non-null.
   * 
   */
  ...
  /**
   * Utility class for initializing an instance of BusinessWeekZone
   */
  public static class CONSTRUCT
  {
    /**
     * Create a new proxy instance of the external entity BusinessWeekZone.
     */
    public static BusinessWeekZone newInstance()
    {
      return (BusinessWeekZone) gw.pl.external.entity.EntityFactory.getInstance().newEntity(BusinessWeekZone.class);
    }
  }
