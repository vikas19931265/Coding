 ...
 */
@Deprecated
public interface ArchiveWorkItem extends com.guidewire.ab.external.entity.WorkItem, gw.pl.external.entity.Entity, gw.pl.external.entity.KeyableEntity
{
  ...
  /**
   *  NOTE: when inserting a ArchiveWorkItem this field must be non-null.
   * 
   */
  ...
  /**
   * Soft foreign key to the item to be processed for archive. NOTE: when inserting a ArchiveWorkItem this field must be non-null.
   * 
   */
  @gw.pl.external.Invocation(type = gw.pl.external.InvocationType.PROPERTY_GETTER, name = "Item")
   ...
   * 
   */
  @gw.pl.external.Invocation(type = gw.pl.external.InvocationType.PROPERTY_SETTER, name = "Item")
  ...
  /**
   * Utility class for initializing an instance of ArchiveWorkItem
   */
  public static class CONSTRUCT
  {
    /**
     * Create a new proxy instance of the external entity ArchiveWorkItem.
     */
    public static ArchiveWorkItem newInstance()
    {
      return (ArchiveWorkItem) gw.pl.external.entity.EntityFactory.getInstance().newEntity(ArchiveWorkItem.class);
    }
  }
