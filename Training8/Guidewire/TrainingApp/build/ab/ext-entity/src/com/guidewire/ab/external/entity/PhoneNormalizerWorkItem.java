 ...
 */
@Deprecated
public interface PhoneNormalizerWorkItem extends com.guidewire.ab.external.entity.WorkItem, gw.pl.external.entity.Entity, gw.pl.external.entity.KeyableEntity
{
  ...
  /**
   *  NOTE: when inserting a PhoneNormalizerWorkItem this field must be non-null.
   * 
   */
  ...
  /**
   * Entity name for the associated ID NOTE: when inserting a PhoneNormalizerWorkItem this field must be non-null.
   * 
   */
  ...
  /**
   * The queue. NOTE: when inserting a PhoneNormalizerWorkItem this field must be non-null.
   * 
   */
  ...
  /**
   * Utility class for initializing an instance of PhoneNormalizerWorkItem
   */
  public static class CONSTRUCT
  {
    /**
     * Create a new proxy instance of the external entity PhoneNormalizerWorkItem.
     */
    public static PhoneNormalizerWorkItem newInstance()
    {
      return (PhoneNormalizerWorkItem) gw.pl.external.entity.EntityFactory.getInstance().newEntity(PhoneNormalizerWorkItem.class);
    }
  }
