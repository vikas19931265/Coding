 ...
 */
@Deprecated
public interface ABContactCategoryScore extends com.guidewire.ab.external.entity.ABLinkable, com.guidewire.ab.external.entity.Versionable, gw.pl.external.entity.Entity
{
  ...
  /**
   * Utility class for initializing an instance of ABContactCategoryScore
   */
  public static class CONSTRUCT
  {
    /**
     * Create a new proxy instance of the external entity ABContactCategoryScore.
     */
    public static ABContactCategoryScore newInstance()
    {
      return (ABContactCategoryScore) gw.pl.external.entity.EntityFactory.getInstance().newEntity(ABContactCategoryScore.class);
    }
  }
