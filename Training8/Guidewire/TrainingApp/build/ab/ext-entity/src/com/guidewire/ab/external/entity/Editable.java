 ...
 */
@Deprecated
public interface Editable extends com.guidewire.ab.external.entity.Versionable, gw.pl.external.entity.Entity
{
  ...
  /**
   * Utility class for initializing an instance of Editable
   */
  public static class CONSTRUCT
  {
    /**
     * Create a new proxy instance of the external entity Editable.
     */
    public static Editable newInstance()
    {
      return (Editable) gw.pl.external.entity.EntityFactory.getInstance().newEntity(Editable.class);
    }
  }
