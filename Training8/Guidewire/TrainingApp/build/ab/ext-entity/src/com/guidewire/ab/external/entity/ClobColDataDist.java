 ...
 */
@Deprecated
public interface ClobColDataDist extends gw.pl.external.entity.Entity, gw.pl.external.entity.KeyableEntity
{


  /**
   * Average length of blob values. NOTE: when inserting a ClobColDataDist this field must be non-null.
   * 
   */
  ...
  /**
   * Clob column name. NOTE: when inserting a ClobColDataDist this field must be non-null.
   * 
   */
  @gw.pl.external.Invocation(type = gw.pl.external.InvocationType.PROPERTY_GETTER, name = "ClobColName")
   ...
   * 
   */
  @gw.pl.external.Invocation(type = gw.pl.external.InvocationType.PROPERTY_SETTER, name = "ClobColName")
  ...
  /**
   * Maximum length of blob values. NOTE: when inserting a ClobColDataDist this field must be non-null.
   * 
   */
  ...
  /**
   * Minimum length of blob values. NOTE: when inserting a ClobColDataDist this field must be non-null.
   * 
   */
  ...
  /**
   * Count of # of non null values. NOTE: when inserting a ClobColDataDist this field must be non-null.
   * 
   */
  ...
  /**
   * Utility class for initializing an instance of ClobColDataDist
   */
  public static class CONSTRUCT
  {
    /**
     * Create a new proxy instance of the external entity ClobColDataDist.
     */
    public static ClobColDataDist newInstance()
    {
      return (ClobColDataDist) gw.pl.external.entity.EntityFactory.getInstance().newEntity(ClobColDataDist.class);
    }
  }
