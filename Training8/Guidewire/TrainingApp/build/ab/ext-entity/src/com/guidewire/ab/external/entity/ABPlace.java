 ...
 */
@Deprecated
public interface ABPlace extends com.guidewire.ab.external.entity.ABContact
{
  ...
  /**
   * Utility class for initializing an instance of ABPlace
   */
  public static class CONSTRUCT
  {
    /**
     * Create a new proxy instance of the external entity ABPlace.
     */
    public static ABPlace newInstance()
    {
      return (ABPlace) gw.pl.external.entity.EntityFactory.getInstance().newEntity(ABPlace.class);
    }
  }
