 ...
 */
@Deprecated
public interface Place extends com.guidewire.ab.external.entity.Contact
{
  ...
  /**
   * Utility class for initializing an instance of Place
   */
  public static class CONSTRUCT
  {
    /**
     * Create a new proxy instance of the external entity Place.
     */
    public static Place newInstance()
    {
      return (Place) gw.pl.external.entity.EntityFactory.getInstance().newEntity(Place.class);
    }
  }
