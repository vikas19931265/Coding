 ...
 */
@Deprecated
public interface ConsistencyCheckWorkItem extends com.guidewire.ab.external.entity.WorkItem, gw.pl.external.entity.Entity, gw.pl.external.entity.KeyableEntity
{
  ...
  /**
   *  NOTE: when inserting a ConsistencyCheckWorkItem this field must be non-null.
   * 
   */
  @gw.pl.external.Invocation(type = gw.pl.external.InvocationType.PROPERTY_GETTER, name = "CheckType")
  public com.guidewire.ab.external.typelist.ConsistencyCheckType getCheckType();

  /**
   *  NOTE: when inserting a ConsistencyCheckWorkItem this field must be non-null.
   * 
   */
  @gw.pl.external.Invocation(type = gw.pl.external.InvocationType.PROPERTY_SETTER, name = "CheckType")
  public void setCheckType(com.guidewire.ab.external.typelist.ConsistencyCheckType value);
  ...
  /**
   * The table on which to run consistency checks NOTE: when inserting a ConsistencyCheckWorkItem this field must be non-null.
   * 
   */
  ...
  /**
   * Utility class for initializing an instance of ConsistencyCheckWorkItem
   */
  public static class CONSTRUCT
  {
    /**
     * Create a new proxy instance of the external entity ConsistencyCheckWorkItem.
     */
    public static ConsistencyCheckWorkItem newInstance()
    {
      return (ConsistencyCheckWorkItem) gw.pl.external.entity.EntityFactory.getInstance().newEntity(ConsistencyCheckWorkItem.class);
    }
  }
