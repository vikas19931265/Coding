 ...
 */
@Deprecated
public interface PersonVendor extends com.guidewire.ab.external.entity.Person
{
  ...
  /**
   * Utility class for initializing an instance of PersonVendor
   */
  public static class CONSTRUCT
  {
    /**
     * Create a new proxy instance of the external entity PersonVendor.
     */
    public static PersonVendor newInstance()
    {
      return (PersonVendor) gw.pl.external.entity.EntityFactory.getInstance().newEntity(PersonVendor.class);
    }
  }
