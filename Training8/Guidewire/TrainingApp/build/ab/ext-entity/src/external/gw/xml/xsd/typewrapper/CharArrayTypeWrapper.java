 ...
 */
@Deprecated
public interface CharArrayTypeWrapper extends external.gw.xml.xsd.typewrapper.XSDTypeWrapper
{
  ...
  /**
   * Utility class for initializing an instance of external.gw.xml.xsd.typewrapper.CharArrayTypeWrapper
   */
  public static class CONSTRUCT
  {
     ...
     */
    public static CharArrayTypeWrapper newInstance()
    {
      return (CharArrayTypeWrapper) gw.pl.external.Invoker.getInstance().construct(external.gw.xml.xsd.typewrapper.CharArrayTypeWrapper.class, new Class[]{ } , new Object[]{ });
    }
