 ...
 */
@Deprecated
public interface Base64BinaryTypeWrapper extends external.gw.xml.xsd.typewrapper.XSDTypeWrapper
{
  ...
  /**
   * Utility class for initializing an instance of external.gw.xml.xsd.typewrapper.Base64BinaryTypeWrapper
   */
  public static class CONSTRUCT
  {
     ...
     */
    public static Base64BinaryTypeWrapper newInstance()
    {
      return (Base64BinaryTypeWrapper) gw.pl.external.Invoker.getInstance().construct(external.gw.xml.xsd.typewrapper.Base64BinaryTypeWrapper.class, new Class[]{ } , new Object[]{ });
    }
