 ...
 */
@Deprecated
public interface EnumTypeWrapper extends external.gw.xml.xsd.typewrapper.XSDTypeWrapper
{
  ...
  /**
   * Utility class for initializing an instance of external.gw.xml.xsd.typewrapper.EnumTypeWrapper
   */
  public static class CONSTRUCT
  {
     ...
     */
    public static EnumTypeWrapper newInstance(gw.pl.external.Type param)
    {
      return (EnumTypeWrapper) gw.pl.external.Invoker.getInstance().construct(external.gw.xml.xsd.typewrapper.EnumTypeWrapper.class, new Class[]{ gw.pl.external.Type.class} , new Object[]{ param});
    }
