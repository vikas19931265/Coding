 ...
 */
@Deprecated
public interface UnsignedByteTypeWrapper extends external.gw.xml.xsd.typewrapper.XSDTypeWrapper
{
  ...
  /**
   * Utility class for initializing an instance of external.gw.xml.xsd.typewrapper.UnsignedByteTypeWrapper
   */
  public static class CONSTRUCT
  {
     ...
     */
    public static UnsignedByteTypeWrapper newInstance()
    {
      return (UnsignedByteTypeWrapper) gw.pl.external.Invoker.getInstance().construct(external.gw.xml.xsd.typewrapper.UnsignedByteTypeWrapper.class, new Class[]{ } , new Object[]{ });
    }
