...
public class Client {
	...
	public static void main(String[] args) {
		...
		ApplicationContext context = new ClassPathXmlApplicationContext("d3com/pgm/lazyinit/Student.xml");
		...
		Address adr2=context.getBean("secondaryAddress",Address.class);
