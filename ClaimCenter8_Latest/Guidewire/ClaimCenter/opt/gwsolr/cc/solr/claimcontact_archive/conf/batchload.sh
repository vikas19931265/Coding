...
jarfiles="solr-1.0-SNAPSHOT.jar commons-lang3-3.1.jar log4j-1.2.16.jar ojdbc7-12.1.0.1.0.jar db2jcc4-0.jar sqljdbc4-4.0.2206.100.jar h2-1.2.147.jar httpcore-4.2.1.jar httpclient-4.2.1.jar"
JARS=.
for jar in $jarfiles
do
  jar=$LIBDIR/$jar
...
java $DEBUG -cp $DIRNAME:$JARS:$SOLRJARS:$SERVLETJAR:$TRANSFORMERJARS com.guidewire.solr.batchload.SolrBatchLoader $CONFIGFILE 2>&1 | tee $DIRNAME/solr-batchload.log
