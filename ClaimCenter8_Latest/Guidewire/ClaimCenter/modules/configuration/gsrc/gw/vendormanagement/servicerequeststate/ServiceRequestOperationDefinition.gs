...
class ServiceRequestOperationDefinition {
  ...
  private static final var REQUIRED_FIELDS : Map<ServiceRequestOperation, List<IPropertyReference>> = {
    ...
    TC_REQUESTREQUOTE -> {OperationContext#Statement, OperationContext#RequestedCompletionDate, OperationContext#Reason},
    TC_SPECIALISTWAITING -> {OperationContext#Reason},
    TC_UPDATEQUOTEECD -> {OperationContext#ExpectedCompletionDate, OperationContext#Reason, OperationContext#OriginalDate},
    TC_UPDATESERVICEECD -> {OperationContext#ExpectedCompletionDate, OperationContext#Reason, OperationContext#OriginalDate},
