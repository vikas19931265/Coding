    ...
    for (x in 1..21) {
      ...
      runChunk( \-> {
        ...
        policies.add(new gw.api.databuilder.PolicyBuilder()
            ...
            .withExpirationDate("2020-01-01" as java.util.Date)
            .withUnderwritingCo("parent")
            .withVerified(true)
            .withOrigEffectiveDate("2007-01-01" as java.util.Date)
            .withAccount("Account 1")
            .withCurrency(CurrencyUtil.getDefaultCurrency())
            .withUnderwritingGroup("acme_auto")
            .withEffectiveDate("2010-01-01" as java.util.Date)
            .withStatus("inforce")
            ...
            .withTotalVehicles(2)
            // policy contacts
            .withContactInRole(contactMap.get("lab_person:"+suffix), "insured")
