...
enhancement GWClaimServiceRequestEnhancement : entity.Claim {
   ...
   */
  function newServiceRequest(custContact : Contact, incident : Incident) : ServiceRequest {
    var serviceRequest = new ServiceRequest()
    serviceRequest.Claim = this
    var instruction = new ServiceRequestInstruction()
    serviceRequest.Instruction = instruction
    ...
    if (custContact != null) {
      ...
      contact = this.claimant?: this.Insured
    }
    instruction.CustomerContact = contact
    serviceRequest.Incident = incident
  ...
  private function removeUnusedAndUnstartedServiceRequests(unusedServiceRequests: Collection <ServiceRequest>, onRemove: block(sr: ServiceRequest) = null) {
    ...
    for (var serviceRequest in this.ServiceRequests) {
