...
class CheckCreatorGosuBase extends CheckCreator {
   ...
   * 
   * @return newCheck
   * @throws com.guidewire.pl.system.exception.InvalidPaymentException
   *          if the payment being made is not valid
   * @throws com.guidewire.pl.system.exception.InsufficientAuthorityException
   *          if the submitting user does not have authority to create the check
   * @throws com.guidewire.pl.system.exception.PaymentExceedsReservesException
   *          if Payment Exceeds Reserves is not allowed and the check violates it
   * @throws com.guidewire.pl.system.exception.WorkflowValidationException
   *          if there is a problem during workflow validation
   */
