...
class PCObjectConverterFactory 
{
  ...
  construct() {
    try 
    {
      var pcToCcFile = CCConfigResourceKeys.PCTOCC_DATAMAPPING_PC702.getFile()
      _pcToCCTranslator = new PolicyNameTranslatorImpl( pcToCcFile, "soap.pcintegrationPC702.entity", "entity" )
    } 
    catch( e : Throwable ) 
    {
