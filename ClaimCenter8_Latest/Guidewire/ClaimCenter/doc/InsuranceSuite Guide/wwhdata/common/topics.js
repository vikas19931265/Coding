...
else if (Guidewire_TopicMatch(TOPIC,"Guidewire ClaimCenter\u00ae") && Guidewire_FMSourceFileMatch(SRCFILE,"cover-suite.html") ) { return "cover-suite.html";}
...
else if (Guidewire_TopicMatch(TOPIC,"InsuranceSuite Features") && Guidewire_FMSourceFileMatch(SRCFILE,"suite-features.3.1.html") ) { return "suite-features.3.1.html";}
else if (Guidewire_TopicMatch(TOPIC,"InsuranceSuite Feature Overview") && Guidewire_FMSourceFileMatch(SRCFILE,"suite-features.3.2.html") ) { return "suite-features.3.2.html";}
