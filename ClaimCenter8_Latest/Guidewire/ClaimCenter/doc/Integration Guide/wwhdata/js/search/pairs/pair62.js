...
x.t("simple","example");
x.t("simple","typecode");
x.t("go","claimcenter/modules/configuration/config/typelists/mapping/typecodemapping.xml");
x.t("entry","contains");
x.t("check","printing");
...
x.t("getinternalcodebyalias","java");
x.t("error","occurred");
...
x.t("templates","used");
x.t("step","using");
x.t("claimcenter/modules/configuration/config/typelists/mapping/typecodemapping.xml","file");
