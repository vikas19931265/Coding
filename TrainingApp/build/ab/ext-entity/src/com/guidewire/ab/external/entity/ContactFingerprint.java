 ...
 */
@Deprecated
public interface ContactFingerprint extends com.guidewire.ab.external.entity.Editable, gw.pl.external.entity.Entity
{
  ...
  /**
   * Utility class for initializing an instance of ContactFingerprint
   */
  public static class CONSTRUCT
  {
    /**
     * Create a new proxy instance of the external entity ContactFingerprint.
     */
    public static ContactFingerprint newInstance()
    {
      return (ContactFingerprint) gw.pl.external.entity.EntityFactory.getInstance().newEntity(ContactFingerprint.class);
    }
  }
