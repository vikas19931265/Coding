 ...
 */
@Deprecated
public interface DBStatisticsWorkItem extends com.guidewire.ab.external.entity.WorkItem, gw.pl.external.entity.Entity, gw.pl.external.entity.KeyableEntity
{
  ...
  /**
   *  NOTE: when inserting a DBStatisticsWorkItem this field must be non-null.
   * 
   */
  ...
  /**
   * The table on which to run statistics NOTE: when inserting a DBStatisticsWorkItem this field must be non-null.
   * 
   */
  ...
  /**
   * Utility class for initializing an instance of DBStatisticsWorkItem
   */
  public static class CONSTRUCT
  {
    /**
     * Create a new proxy instance of the external entity DBStatisticsWorkItem.
     */
    public static DBStatisticsWorkItem newInstance()
    {
      return (DBStatisticsWorkItem) gw.pl.external.entity.EntityFactory.getInstance().newEntity(DBStatisticsWorkItem.class);
    }
  }
