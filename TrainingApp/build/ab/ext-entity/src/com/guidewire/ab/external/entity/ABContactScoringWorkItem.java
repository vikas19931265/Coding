 ...
 */
@Deprecated
public interface ABContactScoringWorkItem extends com.guidewire.ab.external.entity.WorkItem, gw.pl.external.entity.Entity, gw.pl.external.entity.KeyableEntity
{


  /**
   * ABContact to be scored. NOTE: when inserting a ABContactScoringWorkItem this field must be non-null.
   * 
   */
  ...
  /**
   *  NOTE: when inserting a ABContactScoringWorkItem this field must be non-null.
   * 
   */
  ...
  /**
   * Utility class for initializing an instance of ABContactScoringWorkItem
   */
  public static class CONSTRUCT
  {
    /**
     * Create a new proxy instance of the external entity ABContactScoringWorkItem.
     */
    public static ABContactScoringWorkItem newInstance()
    {
      return (ABContactScoringWorkItem) gw.pl.external.entity.EntityFactory.getInstance().newEntity(ABContactScoringWorkItem.class);
    }
  }
