 ...
 */
@Deprecated
public interface AddressAutofillEntity extends com.guidewire.ab.external.entity.AddressAutofillable, com.guidewire.ab.external.entity.Versionable, gw.pl.external.entity.Entity
{
  ...
  /**
   * Utility class for initializing an instance of AddressAutofillEntity
   */
  public static class CONSTRUCT
  {
    /**
     * Create a new proxy instance of the external entity AddressAutofillEntity.
     */
    public static AddressAutofillEntity newInstance()
    {
      return (AddressAutofillEntity) gw.pl.external.entity.EntityFactory.getInstance().newEntity(AddressAutofillEntity.class);
    }
  }
