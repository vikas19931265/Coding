 ...
 */
@Deprecated
public interface Retireable extends com.guidewire.ab.external.entity.Editable, gw.pl.external.entity.Entity
{
  ...
  /**
   * True if the object has been retired from active use, false if the
  ...
  /**
   * Utility class for initializing an instance of Retireable
   */
  public static class CONSTRUCT
  {
    /**
     * Create a new proxy instance of the external entity Retireable.
     */
    public static Retireable newInstance()
    {
      return (Retireable) gw.pl.external.entity.EntityFactory.getInstance().newEntity(Retireable.class);
    }
  }
