 ...
 */
@Deprecated
public interface CompanyVendor extends com.guidewire.ab.external.entity.Company
{
  ...
  /**
   * Utility class for initializing an instance of CompanyVendor
   */
  public static class CONSTRUCT
  {
    /**
     * Create a new proxy instance of the external entity CompanyVendor.
     */
    public static CompanyVendor newInstance()
    {
      return (CompanyVendor) gw.pl.external.entity.EntityFactory.getInstance().newEntity(CompanyVendor.class);
    }
  }
