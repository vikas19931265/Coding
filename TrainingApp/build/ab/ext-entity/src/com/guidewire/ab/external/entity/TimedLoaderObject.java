 ...
 */
@Deprecated
public interface TimedLoaderObject extends gw.pl.external.entity.Entity
{
  ...
  /**
   * Utility class for initializing an instance of TimedLoaderObject
   */
  public static class CONSTRUCT
  {
    /**
     * Create a new proxy instance of the external entity TimedLoaderObject.
     */
    public static TimedLoaderObject newInstance()
    {
      return (TimedLoaderObject) gw.pl.external.entity.EntityFactory.getInstance().newEntity(TimedLoaderObject.class);
    }
  }
