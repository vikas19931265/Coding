 ...
 */
@Deprecated
public interface NMTokenTypeWrapper extends external.gw.xml.xsd.typewrapper.XSDTypeWrapper
{
  ...
  /**
   * Utility class for initializing an instance of external.gw.xml.xsd.typewrapper.NMTokenTypeWrapper
   */
  public static class CONSTRUCT
  {
     ...
     */
    public static NMTokenTypeWrapper newInstance()
    {
      return (NMTokenTypeWrapper) gw.pl.external.Invoker.getInstance().construct(external.gw.xml.xsd.typewrapper.NMTokenTypeWrapper.class, new Class[]{ } , new Object[]{ });
    }
