 ...
 */
@Deprecated
public interface HexBinaryTypeWrapper extends external.gw.xml.xsd.typewrapper.XSDTypeWrapper
{
  ...
  /**
   * Utility class for initializing an instance of external.gw.xml.xsd.typewrapper.HexBinaryTypeWrapper
   */
  public static class CONSTRUCT
  {
     ...
     */
    public static HexBinaryTypeWrapper newInstance()
    {
      return (HexBinaryTypeWrapper) gw.pl.external.Invoker.getInstance().construct(external.gw.xml.xsd.typewrapper.HexBinaryTypeWrapper.class, new Class[]{ } , new Object[]{ });
    }
