 ...
 */
@Deprecated
public interface NormalizedStringTypeWrapper extends external.gw.xml.xsd.typewrapper.XSDTypeWrapper
{
  ...
  /**
   * Utility class for initializing an instance of external.gw.xml.xsd.typewrapper.NormalizedStringTypeWrapper
   */
  public static class CONSTRUCT
  {
     ...
     */
    public static NormalizedStringTypeWrapper newInstance()
    {
      return (NormalizedStringTypeWrapper) gw.pl.external.Invoker.getInstance().construct(external.gw.xml.xsd.typewrapper.NormalizedStringTypeWrapper.class, new Class[]{ } , new Object[]{ });
    }
