 ...
 */
@Deprecated
public interface IntegerTypeWrapper extends external.gw.xml.xsd.typewrapper.XSDTypeWrapper
{
  ...
  /**
   * Utility class for initializing an instance of external.gw.xml.xsd.typewrapper.IntegerTypeWrapper
   */
  public static class CONSTRUCT
  {
     ...
     */
    public static IntegerTypeWrapper newInstance(boolean param)
    {
      return (IntegerTypeWrapper) gw.pl.external.Invoker.getInstance().construct(external.gw.xml.xsd.typewrapper.IntegerTypeWrapper.class, new Class[]{ boolean.class} , new Object[]{ param});
    }
