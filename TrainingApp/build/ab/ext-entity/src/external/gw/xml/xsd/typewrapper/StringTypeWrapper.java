 ...
 */
@Deprecated
public interface StringTypeWrapper extends external.gw.xml.xsd.typewrapper.XSDTypeWrapper
{
  ...
  /**
   * Utility class for initializing an instance of external.gw.xml.xsd.typewrapper.StringTypeWrapper
   */
  public static class CONSTRUCT
  {
     ...
     */
    public static StringTypeWrapper newInstance()
    {
      return (StringTypeWrapper) gw.pl.external.Invoker.getInstance().construct(external.gw.xml.xsd.typewrapper.StringTypeWrapper.class, new Class[]{ } , new Object[]{ });
    }
