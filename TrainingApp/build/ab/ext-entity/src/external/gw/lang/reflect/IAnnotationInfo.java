 ...
 */
@Deprecated
public interface IAnnotationInfo extends java.io.Serializable
{
  /**
   * 
   * 
   ...
   * 
   */
  @gw.pl.external.Invocation(type = gw.pl.external.InvocationType.PROPERTY_GETTER, name = "Instance")
   ...
   * @param param String
   */
  @gw.pl.external.Invocation(type = gw.pl.external.InvocationType.METHOD, name = "getFieldValue")
  public java.lang.Object getFieldValue(java.lang.String param);
