 ...
 */
public class Message  extends com.guidewire.ab.webservices.entity.GWObject  implements java.io.Serializable {
    /** 
 ...
 * instead.
    ...
    /** 
        Number of acks received. NOTE: when inserting a Message this field
 * must be non-null.
     */ 
    ...
    /** 
        Time of creating the message. NOTE: when inserting a Message this
 * field must be non-null.
    ...
    /** 
        Identifies the destination to send this message to. NOTE: when
 * inserting a Message this field must be non-null.
     */ 
    private java.lang.Integer DestinationID;
    /** 
        Number of duplicate errors received.  This field is obsolete, it
 * is not applicable to active messages.
 * @deprecated Number of duplicate errors received.  This field is obsolete,
 * it is not applicable to active messages.
     */ 
    ...
    /** 
        Name of the event. NOTE: when inserting a Message this field must
 * be non-null.
     */ 
 ...
 * only to retryable error messages.
    ...
    /** 
        Order in which to send messages. NOTE: when inserting a Message
 * this field must be non-null.
    ...
    /** 
        Message status: 1-Pending send; 2-Pending ack; 3-Error; 4-Retryable
 * error NOTE: when inserting a Message this field must be non-null.
     */ 
 ...
 * must be non-null.
     * 
     * @return AckCount Number of acks received. NOTE: when inserting a Message this field
 * must be non-null.
     */
 ...
 * must be non-null.
     * 
     * @param AckCount Number of acks received. NOTE: when inserting a Message this field
 * must be non-null.
     */
 ...
 * field must be non-null.
     * 
     * @return CreationTime Time of creating the message. NOTE: when inserting a Message this
 * field must be non-null.
     */
 ...
 * field must be non-null.
     * 
     * @param CreationTime Time of creating the message. NOTE: when inserting a Message this
 * field must be non-null.
     */
 ...
 * inserting a Message this field must be non-null.
     * 
     * @return DestinationID Identifies the destination to send this message to. NOTE: when
 * inserting a Message this field must be non-null.
     */
 ...
 * inserting a Message this field must be non-null.
     * 
     * @param DestinationID Identifies the destination to send this message to. NOTE: when
 * inserting a Message this field must be non-null.
     */
 ...
 * it is not applicable to active messages.
     * 
     * @return DuplicateCount Number of duplicate errors received.  This field is obsolete, it
 * is not applicable to active messages.
 * @deprecated Number of duplicate errors received.  This field is obsolete,
 * it is not applicable to active messages.
     */
 ...
 * it is not applicable to active messages.
     * 
     * @param DuplicateCount Number of duplicate errors received.  This field is obsolete, it
 * is not applicable to active messages.
 * @deprecated Number of duplicate errors received.  This field is obsolete,
 * it is not applicable to active messages.
     */
     ...
     *  Detailed description of error condition (set in the destination).
     * 
     * @return ErrorDescription Detailed description of error condition (set in the destination).
     */
     ...
     *  Detailed description of error condition (set in the destination).
     * 
     * @param ErrorDescription Detailed description of error condition (set in the destination).
     */
 ...
 * be non-null.
     * 
     * @return EventName Name of the event. NOTE: when inserting a Message this field must
 * be non-null.
     */
 ...
 * be non-null.
     * 
     * @param EventName Name of the event. NOTE: when inserting a Message this field must
 * be non-null.
     */
 ...
 * instead.
     ...
     *  Key of template root object/SOO, encoded as type:id.
     * 
     * @return ObjectKey Key of template root object/SOO, encoded as type:id.
     */
     ...
     *  Key of template root object/SOO, encoded as type:id.
     * 
     * @param ObjectKey Key of template root object/SOO, encoded as type:id.
     */
 ...
 * this field must be non-null.
     * 
     * @return SendOrder Order in which to send messages. NOTE: when inserting a Message
 * this field must be non-null.
     */
 ...
 * this field must be non-null.
     * 
     * @param SendOrder Order in which to send messages. NOTE: when inserting a Message
 * this field must be non-null.
     */
 ...
 * error NOTE: when inserting a Message this field must be non-null.
     * 
     * @return Status Message status: 1-Pending send; 2-Pending ack; 3-Error; 4-Retryable
 * error NOTE: when inserting a Message this field must be non-null.
     */
 ...
 * error NOTE: when inserting a Message this field must be non-null.
     * 
     * @param Status Message status: 1-Pending send; 2-Pending ack; 3-Error; 4-Retryable
 * error NOTE: when inserting a Message this field must be non-null.
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://entity.webservices.ab.guidewire.com/", "Message"));
