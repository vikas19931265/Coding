 ...
 */
public class CreateUpdateOp  extends com.guidewire.ab.webservices.entity.UpdateOp  implements java.io.Serializable {
    /** 
 ...
 * (Entity type on the application side not a ContactManager entity type)
    ...
    /** 
        Temporary ID for the newly created object.  Needs to be unique
 * within this UpdateBatch.  Can be referenced from the FieldUpdateOps.
     */ 
 ...
 * within this UpdateBatch.  Can be referenced from the FieldUpdateOps.
     * 
     * @return ObjectUId Temporary ID for the newly created object.  Needs to be unique
 * within this UpdateBatch.  Can be referenced from the FieldUpdateOps.
     */
 ...
 * within this UpdateBatch.  Can be referenced from the FieldUpdateOps.
     * 
     * @param ObjectUId Temporary ID for the newly created object.  Needs to be unique
 * within this UpdateBatch.  Can be referenced from the FieldUpdateOps.
     */
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CreateUpdateOp.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://entity.webservices.ab.guidewire.com/", "CreateUpdateOp"));
