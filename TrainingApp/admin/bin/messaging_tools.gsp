...
uses java.net.URL
uses gw.webservice.ab.ab800.messagingtoolsapi.MessagingToolsAPI
...
config.ServerOverrideUrl = new URL(MessagingToolsArgs.Server + "/ws/gw/webservice/ab/ab800/MessagingToolsAPI").toURI()
