...
6. If we try to run the program with the name of the program 
    ...
    This will throw the error as to run the program we have to run with the respective .class file, 
    like here in this case with java Sample.java.
...
1. We can compile a java program( java source file) but we can run a single  java .class file only.
