...
// Case 3: If class A2 and B2 declared as public and name of the program is B2.java then we will 
           get compile time error. Two files in a program cannot be declared as public.
