...
2. Within a class we can declare multiple constructors and all these constructors having
   same name but different types of arguments hence all these constructors are considered 
   as overloaded constructors.


3. Hence overloading concept is applicable for the constructors.
...
package Constructors;
 ...
 class Test3 {
     ...
     Test3(int i)  // overloaded constructors.
     {
     ...
     Test3(int i, int j)// overloaded constructors.
     {
