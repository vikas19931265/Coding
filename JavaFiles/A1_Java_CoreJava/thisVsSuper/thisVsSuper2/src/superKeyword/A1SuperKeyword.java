...
the property, we are using parent class constructor from child class. In such way, 
...
{   int par_var=20;
    float Salary;
        ...
        
        {
               ...
               // new Person(name, rollno); //another way found by vikas, but this will create new object of person. It wont use parent object
                                            //of the current child object hence do not use it.
