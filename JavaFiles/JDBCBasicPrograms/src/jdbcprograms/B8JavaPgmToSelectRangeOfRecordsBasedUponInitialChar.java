// Java program to select records based upon the initial character
...
class Test4 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String character =  cn.next()+"%";

        String query = String.format("select * from employees where Ename like '%s'", character);
