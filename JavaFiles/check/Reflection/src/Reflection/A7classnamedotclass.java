...
class Student44 extends Person
{
    ...
    private Student44()
    {
        ...
        create the object of the Student4 class. So now using the object(obj.getClass())
 ...
 class Driver5
{
    public static void main(String[] args)
    {
        ...
        "Class" hence c will start pointing to "Class" object and not Student4 object. 
