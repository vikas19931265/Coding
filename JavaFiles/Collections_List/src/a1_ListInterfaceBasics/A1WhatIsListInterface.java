...
1. List is child interface of Collection interface.
   ...
   List Interface is the sub interface of Collection. It contains methods to insert 
   and delete elements on  index basis.
...
3.  We can preserve insertion order with the help of the indexes and we can differentiate
