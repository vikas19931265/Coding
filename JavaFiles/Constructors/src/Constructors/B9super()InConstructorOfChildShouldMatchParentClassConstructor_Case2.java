...
3. Highly recommended to write no argument constructor when we have defined a parameterised constructor in our class.
   this is because child class default constructor (child(){super()}) make a super() constructor call to the
   default constructor in the parent class and if the default constructor is not present then we
   will get error.
