...
class Test8 implements Left9, Right9
{
    public static void main(String[] args)
    {
       ...
       /* System.out.println(x); 
            ...
            • We are trying to implement both the interfaces in the same class Test8 here hence Test8 has access to x from both the classes. If we will use this variable directly inside non local area then JVM will not be able to identify that for which class this variable belongs to and we will get the ambiguity error.
