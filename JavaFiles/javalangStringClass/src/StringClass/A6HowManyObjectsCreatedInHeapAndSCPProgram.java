...
***Very important point to note:
	...
	SCP and Heap memory will have distinct references. Both sides it is not possible to have the same reference.

Either no object will exist in the side of the String Constant Pool or an object with a reference will exist.
...
2. s1.concat("software");
      ...
      "software" is a string constant ( with double quotes). All the string constant that is content with double quotes
       ...
       to creation of new objects will always be stored in the heap area and not in SCP. SCP only contain the constants.
