...
1.  If we want to design a servlet with this approach then we have to take an user defined class it should be an implementation class to Servlet interface.
...
3.  In servlect execution, to perform the servlets initialization container has to first
...
6. In servlet, service(_,_) method is almost all same as main(_) method in normal Java
   application.
