...
If we wan to prepare HttpServlet then we have to declare a user defined class, it must be extended from
...
22Now connection will terminate. Container will destroy request and response object then goes to waiting state . 
