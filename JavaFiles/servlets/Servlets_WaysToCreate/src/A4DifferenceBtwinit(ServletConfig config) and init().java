...
Step 2. Then servlet container create ServletConfig object for that servlet and Call 
...
this.config= config // initialize the Servlet config object and it is available to you, this is mandatary.
...
Case 2 :
    ...
    There is no method like init(ServletConfig) in your servlet(available but not overidden) so call directly goes to 
