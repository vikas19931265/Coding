...
public class Deductions extends javax.swing.JFrame {
    ...
    public static  double deductions()
    {
        ...
        if(basicSal!=0 && hra!=0 && rent!=0)
        {
            ...
            basicSalYearly= basicSal*totalMonths;
            System.out.println("basic salary yearly is" + basicSalYearly);
            hraYearly=hra*totalMonths;
            rentYearly=rent*totalMonths;
            int monthly1= (int) totalMonths;
            amtFromHR=hra*totalMonths;
            actualRentPaid=rent*totalMonths-(0.1*basicSalYearly);
            if(monthly1!=totalMonths)
            {
               int newMonth=(int)totalMonths+1;
           ...
           if(EmployeeDetails.metroCity.equalsIgnoreCase("yes")  )
            {
                ...
                percentOfBasic=0.5*(basicSalYearly);
            }
            else
            {   System.out.println("non metro city");
                 percentOfBasic=0.4*(basicSalYearly);
            }
        }
        ...
        System.out.println("hra applicable"+ minimumHR);
        grossSalIncludingPF=grossSalIncludingPF-minimumHR;
        System.out.println("gross including pf now is" + grossSalIncludingPF);


    return( deductionAmount+minimumHR);
    }
