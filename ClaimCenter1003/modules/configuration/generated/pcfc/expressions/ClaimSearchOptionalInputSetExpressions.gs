  ...
  public static class ClaimSearchOptionalInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    function available_155 () : java.lang.Boolean {
      return (liveClaimFlag)
                                   and ( gw.api.util.CurrencyUtil.isSingleCurrencyMode() or ClaimSearchCriteria.FinancialCriterion.Currency != null)
    }
    ...
    function available_163 () : java.lang.Boolean {
      return (liveClaimFlag)
                        and ( gw.api.util.CurrencyUtil.isSingleCurrencyMode() or ClaimSearchCriteria.FinancialCriterion.Currency != null)
                        and (ClaimSearchCriteria.FinancialCriterion.Options.length == 0 or ClaimSearchCriteria.FinancialCriterion.ChosenOption != null)
    }
