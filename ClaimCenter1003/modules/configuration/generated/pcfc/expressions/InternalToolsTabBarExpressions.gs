...
class InternalToolsTabBarExpressions {
  ...
  public static class InternalToolsTabBarExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'label' attribute on TabBarLink (id=ReturnTabBarLink) at InternalToolsTabBar.pcf: line 20, column 67
    function label_124 () : java.lang.Object {
      return DisplayKey.get("Web.TabBar.ReturnToApp")
    }
    ...
    function systemAlertBar_onEnter_128 (def :  pcf.SystemAlertBar) : void {
      def.onEnter()
    }
    
    // 'systemAlertBar' attribute on TabBar (id=InternalToolsTabBar) at InternalToolsTabBar.pcf: line 7, column 39
    function systemAlertBar_refreshVariables_129 (def :  pcf.SystemAlertBar) : void {
