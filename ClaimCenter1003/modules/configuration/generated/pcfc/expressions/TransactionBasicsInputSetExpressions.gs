...
class TransactionBasicsInputSetExpressions {
  ...
  public static class TransactionBasicsInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    function def_onEnter_27 (def :  pcf.TransactionExchangeRateInputSet) : void {
      def.onEnter(Transaction)
    }
    
    // 'def' attribute on InputSetRef at TransactionBasicsInputSet.pcf: line 54, column 25
    function def_refreshVariables_28 (def :  pcf.TransactionExchangeRateInputSet) : void {
      def.refreshVariables(Transaction)
    }
    
    // 'label' attribute on TypeKeyInput (id=ReservingCurrency_Input) at TransactionBasicsInputSet.pcf: line 36, column 70
    function label_12 () : java.lang.Object {
      return DisplayKey.get("NVV.Financials.SubView.TransactionBasics.Transaction.ReservingCurrency")
    }
