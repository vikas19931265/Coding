...
class BodilyInjuryDamageDVExpressions {
  ...
  public static class BodilyInjuryDamageDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on InputSetRef at BodilyInjuryDamageDV.pcf: line 184, column 51
    function def_onEnter_140 (def :  pcf.ExposureWorkloadInputSet) : void {
      def.onEnter(Exposure)
    }
    
    // 'def' attribute on ListViewInput at BodilyInjuryDamageDV.pcf: line 219, column 27
    function def_onEnter_157 (def :  pcf.EditableOtherCoverageDetailsLV) : void {
      def.onEnter(Exposure)
    }
    
    // 'def' attribute on InputSetRef at BodilyInjuryDamageDV.pcf: line 251, column 49
    function def_onEnter_174 (def :  pcf.DeductibleInfoInputSet) : void {
      def.onEnter(Exposure)
    }
    ...
    // 'def' attribute on InputSetRef at BodilyInjuryDamageDV.pcf: line 184, column 51
    function def_refreshVariables_141 (def :  pcf.ExposureWorkloadInputSet) : void {
      def.refreshVariables(Exposure)
    }
    ...
    // 'def' attribute on InputSetRef at BodilyInjuryDamageDV.pcf: line 251, column 49
    function def_refreshVariables_175 (def :  pcf.DeductibleInfoInputSet) : void {
      def.refreshVariables(Exposure)
    }
    ...
    // 'value' attribute on TypeKeyInput (id=JurisdictionState_Input) at BodilyInjuryDamageDV.pcf: line 205, column 43
    ...
    // 'value' attribute on BooleanRadioInput (id=Claimant_OtherCoverage_Input) at BodilyInjuryDamageDV.pcf: line 214, column 41
    ...
    // 'filter' attribute on TypeKeyInput (id=JurisdictionState_Input) at BodilyInjuryDamageDV.pcf: line 205, column 43
    function filter_151 (VALUE :  typekey.Jurisdiction, VALUES :  typekey.Jurisdiction[]) : java.lang.Boolean {
    ...
    // 'value' attribute on CurrencyInput (id=RemainingReserves_Input) at BodilyInjuryDamageDV.pcf: line 232, column 57
    ...
    // 'value' attribute on TypeKeyInput (id=Segment_Input) at BodilyInjuryDamageDV.pcf: line 193, column 43
    function value_142 () : typekey.ClaimSegment {
      return Exposure.Segment
    }
    
    // 'value' attribute on TypeKeyInput (id=Strategy_Input) at BodilyInjuryDamageDV.pcf: line 198, column 44
    function value_145 () : typekey.ClaimStrategy {
    ...
    // 'value' attribute on CurrencyInput (id=FuturePayments_Input) at BodilyInjuryDamageDV.pcf: line 236, column 54
    function value_162 () : gw.api.financials.CurrencyAmount {
      return Exposure.ExposureRpt.FuturePayments
    }
    
    // 'value' attribute on CurrencyInput (id=TotalPayments_Input) at BodilyInjuryDamageDV.pcf: line 240, column 53
    function value_165 () : gw.api.financials.CurrencyAmount {
      return Exposure.ExposureRpt.TotalPayments
    }
    
    // 'value' attribute on CurrencyInput (id=TotalRecoveries_Input) at BodilyInjuryDamageDV.pcf: line 244, column 55
    function value_168 () : gw.api.financials.CurrencyAmount {
      return Exposure.ExposureRpt.TotalRecoveries
    }
    
    // 'value' attribute on CurrencyInput (id=TotalIncurredNet_Input) at BodilyInjuryDamageDV.pcf: line 249, column 56
