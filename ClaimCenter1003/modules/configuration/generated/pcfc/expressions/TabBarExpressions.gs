...
class TabBarExpressions {
  ...
  public static class TabBarExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on HiddenLink (id=ProfilerHiddenLink) at TabBar.pcf: line 168, column 26
    function action_115 () : void {
      ProfilerPopup.push()
    }
    
    // 'action' attribute on HiddenLink (id=InternalToolsHiddenLink) at TabBar.pcf: line 172, column 26
    ...
    // 'label' attribute on TabBarLogout (id=LogoutTabBarLink) at TabBar.pcf: line 164, column 21
    ...
    function systemAlertBar_onEnter_119 (def :  pcf.SystemAlertBar) : void {
      def.onEnter()
    }
    
    // 'systemAlertBar' attribute on TabBar (id=TabBar) at TabBar.pcf: line 7, column 39
    function systemAlertBar_refreshVariables_120 (def :  pcf.SystemAlertBar) : void {
