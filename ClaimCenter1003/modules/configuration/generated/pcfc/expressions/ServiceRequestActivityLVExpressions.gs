...
class ServiceRequestActivityLVExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends ServiceRequestActivityLVExpressionsImpl {
    ...
    // 'label' attribute on TypeKeyCell (id=Priority_Cell) at ServiceRequestActivityLV.pcf: line 102, column 41
    function label_42 () : java.lang.Object {
      return DisplayKey.get("LV.Activity.ServiceRequest.Activities.Priority")
    }
    
    // 'label' attribute on TextCell (id=Status_Cell) at ServiceRequestActivityLV.pcf: line 108, column 44
    function label_47 () : java.lang.Object {
      return DisplayKey.get("LV.Activity.ServiceRequest.Activities.Status")
    }
    
    // 'label' attribute on TextCell (id=Subject_Cell) at ServiceRequestActivityLV.pcf: line 116, column 135
    function label_54 () : java.lang.Object {
      return DisplayKey.get("LV.Activity.ServiceRequest.Activities.Subject")
    }
  ...
  public static class ServiceRequestActivityLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    function value_64 () : gw.api.database.IQueryBeanResult<entity.Activity> {
      return activityList
    }
