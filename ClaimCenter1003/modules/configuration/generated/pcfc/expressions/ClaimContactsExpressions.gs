...
class ClaimContactsExpressions {
  ...
  public static class CardViewPanelExpressionsImpl extends PeopleInvolvedDetailedListDetailExpressionsImpl {
    ...
    // 'def' attribute on PanelRef at ClaimContacts.pcf: line 177, column 80
    function def_onEnter_59 (def :  pcf.ClaimContactRelatedContactsLV) : void {
      def.onEnter(selectedClaimContact, claim)
    }
    
    // 'def' attribute on PanelRef at ClaimContacts.pcf: line 189, column 84
    function def_onEnter_63 (def :  pcf.ReviewsPanelSet) : void {
    ...
    // 'def' attribute on PanelRef at ClaimContacts.pcf: line 177, column 80
    function def_refreshVariables_60 (def :  pcf.ClaimContactRelatedContactsLV) : void {
      def.refreshVariables(selectedClaimContact, claim)
    }
    
    // 'def' attribute on PanelRef at ClaimContacts.pcf: line 189, column 84
    function def_refreshVariables_64 (def :  pcf.ReviewsPanelSet) : void {
    ...
    // 'toolbarButtonSet' attribute on ToolbarButtonSetRef at ClaimContacts.pcf: line 172, column 155
    function toolbarButtonSet_onEnter_57 (def :  pcf.ContactDetailToolbarButtonSet) : void {
      def.onEnter(selectedClaimContact, canAccessLinkButtons, linkStatus, false, allowEditInAddressBook)
    }
    
    // 'toolbarButtonSet' attribute on ToolbarButtonSetRef at ClaimContacts.pcf: line 192, column 156
    function toolbarButtonSet_onEnter_61 (def :  pcf.ContactDetailToolbarButtonSet) : void {
      def.onEnter(selectedClaimContact, canAccessLinkButtons, linkStatus, false, allowEditInAddressBook)
    }
    ...
    // 'toolbarButtonSet' attribute on ToolbarButtonSetRef at ClaimContacts.pcf: line 192, column 156
    function toolbarButtonSet_refreshVariables_62 (def :  pcf.ContactDetailToolbarButtonSet) : void {
      def.refreshVariables(selectedClaimContact, canAccessLinkButtons, linkStatus, false, allowEditInAddressBook)
    }
    ...
    // 'visible' attribute on Card (id=ReviewsCard) at ClaimContacts.pcf: line 187, column 119
  ...
  public static class ClaimContactsExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    function canEdit_66 () : java.lang.Boolean {
    ...
    static function canVisit_67 (claim :  Claim) : java.lang.Boolean {
    ...
    static function handlesValidationIssue_68 (claim :  Claim, VALUE :  java.lang.Object) : java.lang.Boolean {
    ...
    static function parent_69 (claim :  Claim) : pcf.api.Destination {
