...
class PaymentTransferDVExpressions {
  ...
  public static class PaymentTransferDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    function def_onEnter_16 (def :  pcf.PaymentTransferLineItemsLV) : void {
      def.onEnter(Payment)
    }
    ...
    // 'def' attribute on ListViewInput at PaymentTransferDV.pcf: line 42, column 94
    function def_refreshVariables_17 (def :  pcf.PaymentTransferLineItemsLV) : void {
      def.refreshVariables(Payment)
    }
    
    // 'label' attribute on CurrencyInput (id=NetTotalIncurred_Input) at PaymentTransferDV.pcf: line 38, column 47
    function label_11 () : java.lang.Object {
      return DisplayKey.get("NVV.Financials.PaymentTransfer.Payment.NetTotalIncurred")
    }
