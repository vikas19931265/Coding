...
class AdminExpressions {
  ...
  public static class LocationGroupMenuItem11ExpressionsImpl extends AdminExpressionsImpl {
    ...
    // 'location' attribute on LocationGroup (id=Admin) at Utilities.pcf: line 22, column 39
    function action_84 () : void {
      pcf.InboundFileSearch.go()
    }
    
    // 'location' attribute on LocationGroup (id=Admin) at Utilities.pcf: line 24, column 40
    function action_86 () : void {
      pcf.OutboundFileSearch.go()
    }
    
    // 'location' attribute on LocationGroup (id=Admin) at Utilities.pcf: line 26, column 32
