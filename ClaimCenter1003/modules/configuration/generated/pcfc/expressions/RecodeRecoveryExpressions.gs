...
class RecodeRecoveryExpressions {
  ...
  public static class RecodeRecoveryExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    function def_onEnter_18 (def :  pcf.EditableRecodeLineItemsLV) : void {
    ...
    // 'def' attribute on ListViewInput at RecodeRecovery.pcf: line 65, column 31
    function def_refreshVariables_19 (def :  pcf.EditableRecodeLineItemsLV) : void {
    ...
    // 'label' attribute on TypeKeyInput (id=RecoveryCategory_Input) at RecodeRecovery.pcf: line 52, column 50
    function label_7 () : java.lang.Object {
      return DisplayKey.get("Web.Claim.RecodeRecovery.RecoveryCategory")
    }
    
    // 'parent' attribute on Page (id=RecodeRecovery) at RecodeRecovery.pcf: line 12, column 66
    static function parent_23 (originalRecovery :  Recovery) : pcf.api.Destination {
    ...
    // 'value' attribute on TypeKeyInput (id=RecoveryCategory_Input) at RecodeRecovery.pcf: line 52, column 50
    function value_8 () : typekey.RecoveryCategory {
