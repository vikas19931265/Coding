...
class BulkInvoiceSearchOptionalInputSetExpressions {
  ...
  public static class BulkInvoiceSearchOptionalInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    function available_14 () : java.lang.Boolean {
      return (true)
                        and ( gw.api.util.CurrencyUtil.isSingleCurrencyMode() or BulkInvoiceSearchCriteria.FinancialCriterion.Currency != null)
                        and (BulkInvoiceSearchCriteria.FinancialCriterion.Options.length == 0 or BulkInvoiceSearchCriteria.FinancialCriterion.ChosenOption != null)
    }
