...
class RuleImportDetailsPopupExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends RuleImportDetailsPopupExpressionsImpl {
    ...
    function checkBoxVisible_111 () : java.lang.Boolean {
      return pending
    }
    ...
    // 'label' attribute on Link (id=AnotherRuleWithSameNameLink) at RuleImportDetailsPopup.pcf: line 265, column 93
    function label_78 () : java.lang.Object {
      return DisplayKey.get('BizRules.RuleImportDetailsPopup.LV.DuplicatedRuleName')
    }
    ...
    function tooltip_80 () : java.lang.String {
  ...
  public static class RuleImportDetailsPopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    static function canVisit_114 (completed :  boolean, importTask :  RuleImportTask, navigationSupport :  gw.bizrules.pcf.BizRulesPageNavigationSupport) : java.lang.Boolean {
      return gw.bizrules.pcf.RulePermissionUIHelper.canImportRule(importTask.getRuleType().getEntityType())
    }
    ...
    static function title_115 (completed :  boolean, importTask :  RuleImportTask, navigationSupport :  gw.bizrules.pcf.BizRulesPageNavigationSupport) : java.lang.Object {
    ...
    function value_113 () : gw.api.database.IQueryBeanResult<RuleImportTaskEntry> {
