...
class ClaimSnapshotPolicyScreen_800Expressions {
  ...
  public static class ClaimSnapshotPolicyScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    function def_onEnter_55 (def :  pcf.ClaimSnapshotPolicyStatCodes800LV) : void {
      def.onEnter(Claim, SnapshotParam)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotPolicyScreen.800.pcf: line 165, column 76
    function def_onEnter_58 (def :  pcf.ClaimSnapshotPolicyEndorsements800LV) : void {
      def.onEnter(Claim, SnapshotParam)
    }
    ...
    // 'def' attribute on PanelRef at ClaimSnapshotPolicyScreen.800.pcf: line 156, column 73
    function def_refreshVariables_56 (def :  pcf.ClaimSnapshotPolicyStatCodes800LV) : void {
      def.refreshVariables(Claim, SnapshotParam)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotPolicyScreen.800.pcf: line 165, column 76
    function def_refreshVariables_59 (def :  pcf.ClaimSnapshotPolicyEndorsements800LV) : void {
      def.refreshVariables(Claim, SnapshotParam)
    }
  ...
  public static class IteratorEntryExpressionsImpl extends TripCoverageLDPExpressionsImpl {
    ...
    // 'label' attribute on TextCell (id=Currency_Cell) at ClaimSnapshotPolicyScreen.800.pcf: line 115, column 81
  ...
  public static class TripCoverageLDPExpressionsImpl extends ListDetailPanel3ExpressionsImpl {
    ...
    function def_onEnter_47 (def :  pcf.ClaimSnapshotPolicyCovTermsCV_700) : void {
      def.onEnter(SelectedCoverage)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotPolicyScreen.800.pcf: line 145, column 31
    function def_onEnter_49 (def :  pcf.ClaimSnapshotPolicyCovTermsCV_800) : void {
      def.onEnter(SelectedCoverage)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotPolicyScreen.800.pcf: line 145, column 31
    function def_onEnter_51 (def :  pcf.ClaimSnapshotPolicyCovTermsCV_default) : void {
      def.onEnter(SelectedCoverage)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotPolicyScreen.800.pcf: line 145, column 31
    function def_refreshVariables_48 (def :  pcf.ClaimSnapshotPolicyCovTermsCV_700) : void {
      def.refreshVariables(SelectedCoverage)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotPolicyScreen.800.pcf: line 145, column 31
    function def_refreshVariables_50 (def :  pcf.ClaimSnapshotPolicyCovTermsCV_800) : void {
      def.refreshVariables(SelectedCoverage)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotPolicyScreen.800.pcf: line 145, column 31
    function def_refreshVariables_52 (def :  pcf.ClaimSnapshotPolicyCovTermsCV_default) : void {
      def.refreshVariables(SelectedCoverage)
    }
