...
class FinancialsSummaryReservingCurrencyPrintExpressions {
  ...
  public static class FinancialsSummaryReservingCurrencyPrintExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'title' attribute on Page (id=FinancialsSummaryReservingCurrencyPrint) at FinancialsSummaryReservingCurrencyPrint.pcf: line 8, column 82
    static function title_4 (Claim :  Claim, useFloatingFinancials :  boolean) : java.lang.Object {
      return DisplayKey.get("Web.Financials.Summary.ReservingCurrency")
    }
