...
class NewExposureDV_LossofusedamageExpressions {
  ...
  public static class NewExposureDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on PolicyStatCodePickerInput (id=Exposure_StatLine_Input) at NewExposureDV.Lossofusedamage.pcf: line 53, column 63
    ...
    // 'def' attribute on ListViewInput at NewExposureDV.Lossofusedamage.pcf: line 180, column 115
    function def_onEnter_112 (def :  pcf.EditableOtherCoverageDetailsLV) : void {
      def.onEnter(Exposure)
    }
    
    // 'def' attribute on InputSetRef at NewExposureDV.Lossofusedamage.pcf: line 200, column 134
    function def_onEnter_118 (def :  pcf.OtherServicesLVInputSet) : void {
    ...
    // 'def' attribute on InputSetRef at NewExposureDV.Lossofusedamage.pcf: line 200, column 134
    function def_refreshVariables_119 (def :  pcf.OtherServicesLVInputSet) : void {
    ...
    // 'value' attribute on CurrencyInput (id=Exposure_ALEMealsRate_Input) at NewExposureDV.Lossofusedamage.pcf: line 168, column 57
    ...
    // 'value' attribute on BooleanRadioInput (id=Claimant_OtherCoverage_Input) at NewExposureDV.Lossofusedamage.pcf: line 176, column 41
    ...
    // 'value' attribute on RangeInput (id=Exposure_Coverage_Input) at NewExposureDV.Lossofusedamage.pcf: line 44, column 38
    ...
    // 'value' attribute on TypeKeyInput (id=Claimant_Type_Input) at NewExposureDV.Lossofusedamage.pcf: line 90, column 42
    ...
    // 'value' attribute on BooleanRadioInput (id=Claimant_ContactProhibited_Input) at NewExposureDV.Lossofusedamage.pcf: line 105, column 36
    function defaultSetter_64 (__VALUE_TO_SET :  java.lang.Object) : void {
      ContactProhibited = (__VALUE_TO_SET as java.lang.Boolean)
    }
    
    // 'value' attribute on TextAreaInput (id=Exposure_Description_Input) at NewExposureDV.Lossofusedamage.pcf: line 135, column 47
    ...
    // 'value' attribute on BooleanRadioInput (id=Exposure_LossofUse_Input) at NewExposureDV.Lossofusedamage.pcf: line 140, column 44
    ...
    // 'value' attribute on CurrencyInput (id=Exposure_LossEstimate_Input) at NewExposureDV.Lossofusedamage.pcf: line 147, column 48
    ...
    // 'value' attribute on TextInput (id=Exposure_ALEMealsDays_Input) at NewExposureDV.Lossofusedamage.pcf: line 155, column 57
    ...
    // 'value' attribute on TextInput (id=Exposure_ALEMealsPeople_Input) at NewExposureDV.Lossofusedamage.pcf: line 162, column 57
    ...
    // ClaimContactInput (id=Claimant_Picker_Input) at NewExposureDV.Lossofusedamage.pcf: line 75, column 43
    ...
    // 'valueRange' attribute on RangeInput (id=Exposure_Coverage_Input) at NewExposureDV.Lossofusedamage.pcf: line 44, column 38
    ...
    // 'value' attribute on TextInput (id=Claimant_PrimaryPhone_Input) at NewExposureDV.Lossofusedamage.pcf: line 109, column 53
    ...
    // 'value' attribute on TextInput (id=StatLine_Warning_Input) at NewExposureDV.Lossofusedamage.pcf: line 60, column 65
    ...
    // 'value' attribute on ClaimContactInput (id=Claimant_Picker_Input) at NewExposureDV.Lossofusedamage.pcf: line 78, column 45
    ...
    // 'value' attribute on TextInput (id=Claimant_Address_Input) at NewExposureDV.Lossofusedamage.pcf: line 117, column 62
    ...
    // 'visible' attribute on TextInput (id=ServiceRequestSubmitMessageFNOL_Input) at NewExposureDV.Lossofusedamage.pcf: line 193, column 54
    function visible_114 () : java.lang.Boolean {
      return PropertyIncident.Claim.DraftClaim
    }
    
    // 'visible' attribute on TextInput (id=ServiceRequestSubmitMessage_Input) at NewExposureDV.Lossofusedamage.pcf: line 198, column 89
    function visible_116 () : java.lang.Boolean {
      return not PropertyIncident.Claim.DraftClaim and CurrentLocation.InEditMode
    }
    
    // 'visible' attribute on TextInput (id=StatLine_Warning_Input) at NewExposureDV.Lossofusedamage.pcf: line 60, column 65
    ...
    // 'visible' attribute on TextInput (id=Exposure_ALEMealsDays_Input) at NewExposureDV.Lossofusedamage.pcf: line 155, column 57
