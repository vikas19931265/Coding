...
class ClaimSnapshotPartiesInvolvedScreen_defaultExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends ListDetailPanelExpressionsImpl {
    ...
    // 'label' attribute on TextCell (id=ZipCode_Cell) at ClaimSnapshotPartiesInvolvedScreen.default.pcf: line 64, column 44
  ...
  public static class ListDetailPanelExpressionsImpl extends ClaimSnapshotPartiesInvolvedScreenExpressionsImpl {
    ...
    function def_onEnter_33 (def :  pcf.ClaimSnapshotContactDV_Company) : void {
      def.onEnter(SelectedClaimContact)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotPartiesInvolvedScreen.default.pcf: line 74, column 78
    function def_onEnter_35 (def :  pcf.ClaimSnapshotContactDV_Person) : void {
      def.onEnter(SelectedClaimContact)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotPartiesInvolvedScreen.default.pcf: line 74, column 78
    function def_onEnter_37 (def :  pcf.ClaimSnapshotContactDV_Place) : void {
      def.onEnter(SelectedClaimContact)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotPartiesInvolvedScreen.default.pcf: line 74, column 78
    function def_onEnter_39 (def :  pcf.ClaimSnapshotContactDV_contact) : void {
      def.onEnter(SelectedClaimContact)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotPartiesInvolvedScreen.default.pcf: line 74, column 78
    function def_refreshVariables_34 (def :  pcf.ClaimSnapshotContactDV_Company) : void {
      def.refreshVariables(SelectedClaimContact)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotPartiesInvolvedScreen.default.pcf: line 74, column 78
    function def_refreshVariables_36 (def :  pcf.ClaimSnapshotContactDV_Person) : void {
      def.refreshVariables(SelectedClaimContact)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotPartiesInvolvedScreen.default.pcf: line 74, column 78
    function def_refreshVariables_38 (def :  pcf.ClaimSnapshotContactDV_Place) : void {
      def.refreshVariables(SelectedClaimContact)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotPartiesInvolvedScreen.default.pcf: line 74, column 78
    function def_refreshVariables_40 (def :  pcf.ClaimSnapshotContactDV_contact) : void {
      def.refreshVariables(SelectedClaimContact)
    }
