  ...
  override function testSampleData(bundle : Bundle) {
    ...
    new gw.api.databuilder.ReinsuranceThresholdBuilder()
        ...
        .withCoverageType( new gw.api.databuilder.ReinsuranceCoverageBuilder()
            .withCoverage(TC_HOPCOVA))
        .withCoverageType(new gw.api.databuilder.ReinsuranceCoverageBuilder()
            .withCoverage(TC_HOPCOVB))
        .withCoverageType( new gw.api.databuilder.ReinsuranceCoverageBuilder()
            .withCoverage(TC_HOPCOVC))
        .withCoverageType(new gw.api.databuilder.ReinsuranceCoverageBuilder()
            .withCoverage(TC_HOPSCHEDULEDPERSONALPROPERTY))
        .withCoverageType(new gw.api.databuilder.ReinsuranceCoverageBuilder()
            .withCoverage(TC_HOPCOVD))
    ...
    new gw.api.databuilder.ReinsuranceThresholdBuilder()
        ...
        .withReportingThreshold(75)
        .withCoverageType( new gw.api.databuilder.ReinsuranceCoverageBuilder()
            .withCoverage(TC_HOPCOVF))
        .withCoverageType(new gw.api.databuilder.ReinsuranceCoverageBuilder()
            .withCoverage(TC_HOPCOVE))
        .create(bundle)
