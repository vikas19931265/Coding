...
class SampleMetricLimits extends SampleDataBase {
  ...
  private class ClaimMetricLimits {
    ...
    function addLimits() {
      ...
      add(TC_HOPHOMEOWNERS, TC_DAYSOPENCLAIMMETRIC, null, 90, 80, 120)
      add(TC_HOPHOMEOWNERS, TC_DAYSOPENCLAIMMETRIC, TC_LOW, 30, 25, 40)
      add(TC_HOPHOMEOWNERS, TC_DAYSOPENCLAIMMETRIC, TC_HIGH, 180, 160, 200)
      ...
      add(TC_HOPHOMEOWNERS, TC_DAYSINITIALCONTACTWITHINSUREDCLAIMMETRIC, null, 1, 1, 2)
      ...
      add(TC_HOPHOMEOWNERS, TC_DAYSLASTVIEWEDBYADJUSTERCLAIMMETRIC, null, 12, 10, 20)
      add(TC_HOPHOMEOWNERS, TC_DAYSLASTVIEWEDBYADJUSTERCLAIMMETRIC, TC_HIGH, 20, 25, 40)
      ...
      add(TC_HOPHOMEOWNERS, TC_DAYSLASTVIEWEDBYSUPERVISORCLAIMMETRIC, null, 20, 16, 40)
      add(TC_HOPHOMEOWNERS, TC_DAYSLASTVIEWEDBYSUPERVISORCLAIMMETRIC, TC_HIGH, 30, 25, 50)
      ...
      add(TC_HOPHOMEOWNERS, TC_OVERDUEACTIVITIESCLAIMMETRIC, null, null, 2, 3)
      ...
      add(TC_HOPHOMEOWNERS, TC_OPENESCALATEDACTIVITIESCLAIMMETRIC, null, 0, null, 1)
      ...
      add(TC_HOPHOMEOWNERS, TC_ALLESCALATEDACTIVITIESCLAIMMETRIC, null, 1, 1, 2)
      ...
      add(TC_HOPHOMEOWNERS, TC_NETTOTALINCURREDCLAIMMETRIC, null, 5000, null, null)
      add(TC_HOPHOMEOWNERS, TC_NETTOTALINCURREDCLAIMMETRIC, TC_LOW, 1500, null, null)
      add(TC_HOPHOMEOWNERS, TC_NETTOTALINCURREDCLAIMMETRIC, TC_HIGH, 25000, null, null)
