package gw.webservice.cc.cc1000.pcintegration
...
uses gw.webservice.cc.cc1000.pcintegration.pcentities.PCClaim
uses gw.webservice.cc.cc1000.pcintegration.pcentities.PCClaimDetail
uses gw.webservice.cc.cc1000.pcintegration.pcentities.PCClaimSearchCriteria

@gw.xml.ws.annotation.WsiWebService("http://guidewire.com/cc/ws/gw/webservice/cc/cc1000/pcintegration/PCClaimSearchIntegrationAPI")
...
class PCClaimSearchIntegrationAPI {
  ...
  private function addClaims(results : List<PCClaim>, criteria : PCClaimSearchCriteria) {
    var claimState = ClaimState.get(criteria.Status)
    ...
    if (claimState != ClaimState.TC_OPEN and claimState != ClaimState.TC_DRAFT) {
  ...
  private function findClaimQuery(criteria : PCClaimSearchCriteria, claimState : ClaimState) : IQueryBeanResult {
