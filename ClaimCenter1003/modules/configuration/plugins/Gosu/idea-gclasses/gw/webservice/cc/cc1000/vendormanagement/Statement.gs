 ...
 */
@Export
@WsiExportable("http://guidewire.com/cc/ws/gw/webservice/cc/cc1000/vendormanagement/Statement")
final class Statement {
   ...
   */
  var _invoiceCheck : gw.webservice.cc.cc1000.vendormanagement.Check as InvoiceCheck
  ...
  construct(invoice : ServiceRequestInvoice, documentCache : LoadingCache<ServiceRequestDocumentLink,Document>) {
    ...
    if (invoice.Check != null) {
      InvoiceCheck = new gw.webservice.cc.cc1000.vendormanagement.Check(invoice.Check)
    }
  }
