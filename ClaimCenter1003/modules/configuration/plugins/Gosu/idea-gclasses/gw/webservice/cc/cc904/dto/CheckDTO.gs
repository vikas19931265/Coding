 ...
 * A {@link CheckDTO} is a DTO that represents an instance of {@link entity.Check} for use by certain WS-I Web Services in the base product. This file is composed of basic getters and setters, plus members that make it easier for server-side code to work with DTOs, like virtual getters that query for entities by PublicID, and methods to copy fields to or from an instance of {@link entity.Check}.
 ...
 */
@Export
@WsiExportable("http://guidewire.com/cc/ws/gw/webservice/cc/cc904/dto/CheckDTO")
final class CheckDTO {
  ...
  var _reportableAmount               : CurrencyAmount            as ReportableAmount
   ...
   * @param bundleProvider The entity in whose Bundle to create the new Check.
   ...
   */
  final function writeToNewEntityIn(bundleProvider: BundleProvider, createNew: block(): Check = null, ignoreNullValues = true): Check {
    var instance: Check
