 ...
 * A(n) {@link gw.webservice.cc.cc1000.dto.BulkInvoiceItemDTO} is a DTO that represents an instance of {@link BulkInvoiceItem} for use by certain WS-I Web Services in the base product. This file is composed of basic getters and setters, plus members that make it easier for server-side code to work with DTOs, like virtual getters that query for entities by PublicID, and methods to copy fields to or from an instance of {@link BulkInvoiceItem}.
 ...
 * <p>The specific mappings for {@link gw.webservice.cc.cc1000.dto.BulkInvoiceItemDTO} are as follows:
 ...
 */
@Export
@WsiExportable("http://guidewire.com/cc/ws/gw/webservice/cc/cc1000/dto/BulkInvoiceItemDTO")
final class BulkInvoiceItemDTO {
  var _amount              : CurrencyAmount                   as Amount
  ...
  var _deductionsAmount    : CurrencyAmount                   as DeductionsAmount
   ...
   * @param bundleProvider The entity in whose Bundle to create the new BulkInvoiceItem.
   ...
   */
  final function writeToNewEntityIn(bundleProvider: BundleProvider, createNew: block(): BulkInvoiceItem = null, ignoreNullValues = true): BulkInvoiceItem {
