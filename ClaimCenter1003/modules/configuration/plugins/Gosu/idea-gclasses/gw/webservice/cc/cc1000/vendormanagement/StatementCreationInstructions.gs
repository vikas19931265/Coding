 ...
 */
@Export
@WsiExportable("http://guidewire.com/cc/ws/gw/webservice/cc/cc1000/vendormanagement/StatementCreationInstructions")
final class StatementCreationInstructions {
   ...
   */
  var _lineItems: gw.webservice.cc.cc1000.vendormanagement.ServiceRequestStatementLineItem[] as LineItems
