 ...
 */
@Export
@WsiExportable("http://guidewire.com/cc/ws/gw/webservice/cc/cc904/dto/PolicySummaryDTO")
final class PolicySummaryDTO {
   ...
   * @param bundleProvider The entity in whose Bundle to create the new PolicySummary.
   ...
   */
  final function writeToNewEntityIn(bundleProvider: BundleProvider, createNew: block(): PolicySummary = null, ignoreNullValues = true): PolicySummary {
