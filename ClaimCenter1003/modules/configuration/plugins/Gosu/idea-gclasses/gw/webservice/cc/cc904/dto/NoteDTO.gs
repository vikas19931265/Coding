 ...
 * A {@link NoteDTO} is a DTO that represents an instance of {@link entity.Note} for use by certain WS-I Web Services in the base product. This file is composed of basic getters and setters, plus members that make it easier for server-side code to work with DTOs, like virtual getters that query for entities by PublicID, and methods to copy fields to or from an instance of {@link entity.Note}.
 ...
 */
@Export
@WsiExportable("http://guidewire.com/cc/ws/gw/webservice/cc/cc904/dto/NoteDTO")
final class NoteDTO {
   ...
   * @param bundleProvider The entity in whose Bundle to create the new Note.
   ...
   */
  final function writeToNewEntityIn(bundleProvider: BundleProvider, createNew: block(): Note = null, ignoreNullValues = true): Note {
    var instance: Note
