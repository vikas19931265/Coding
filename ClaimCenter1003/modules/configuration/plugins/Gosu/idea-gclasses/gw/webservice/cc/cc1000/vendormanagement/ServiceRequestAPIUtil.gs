...
internal class ServiceRequestAPIUtil {
  ...
  function getMessagesForSpecialist(specialistId: String): MessagesForSpecialistResults {
    ...
    var results = new ArrayList<gw.webservice.cc.cc1000.vendormanagement.Message>()
    ...
    for (message in messages) {
      ...
      results.add(new gw.webservice.cc.cc1000.vendormanagement.Message(message, true))
    }
