...
@Export
abstract class CCRuleCommandDefinitionBuilder<B extends CCRuleCommandDefinitionBuilder, T extends BaseCommandParameterConfig>
  ...
  protected function addToMap(param : CCCommandParameterDefinition, value : ExpressionFragmentBuilder) {
    _commandParameters.put(param.Name, value)
  }
