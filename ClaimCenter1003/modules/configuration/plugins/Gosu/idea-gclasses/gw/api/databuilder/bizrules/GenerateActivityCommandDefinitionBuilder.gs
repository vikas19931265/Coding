...
class GenerateActivityCommandDefinitionBuilder extends HasRelatedToCommandDefinitionBuilder<GenerateActivityCommandDefinitionBuilder, GenerateActivityCommandParameterConfig> {
  ...
  function withSubject(language : LanguageType, subject : String) : GenerateActivityCommandDefinitionBuilder {
    var param = Config.SUBJECT.Localizations[language] ?: Config.SUBJECT
    addToMap(param, ExpressionFragmentBuilders.forGosuTemplateExpression(subject))
    return this
  }
  ...
  function withDescription(language : LanguageType, description : String) : GenerateActivityCommandDefinitionBuilder {
    var param = Config.DESCRIPTION.Localizations[language] ?: Config.DESCRIPTION
    addToMap(param,ExpressionFragmentBuilders.forGosuTemplateExpression(description))
    return this
  }
