  ...
  function setExposureTier() : void {
    ...
    */
    ...
    switch (this.Claim.Policy.PolicyType) {
      case LOBAbstraction.ForPolicy.PersonalAutoPolicyType:
      case LOBAbstraction.ForPolicy.CommercialAutoPolicyType:
      case LOBAbstraction.ForPolicy.HOPPolicyType:
      case LOBAbstraction.ForPolicy.CommercialPropertyPolicyType:
        setAutoPropertyExposureTier()
        break

      case LOBAbstraction.ForPolicy.WorkCompPolicyType:
        setWCExposureTier()
        break  

      case LOBAbstraction.ForPolicy.PersonalTravelPolicyType:
