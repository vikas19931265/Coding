...
uses wsi.remote.gw.webservice.pc.pc910.entities.types.complex.CCPCSearchCriteria
uses wsi.remote.gw.webservice.pc.pc910.entities.types.complex.CCPolicy
uses wsi.remote.gw.webservice.pc.pc910.entities.types.complex.CCPolicySummary
...
class PolicySearchConverter {
  public static var INSTANCE : gw.plugin.pcintegration.pc910.PolicySearchConverter = new gw.plugin.pcintegration.pc910.PolicySearchConverter()

  private var _pcToCC : ObjectConverter
  private var _nameTranslator : NameTranslator as readonly NameMapper
  
  public construct()   {
    var converterFactory = new gw.plugin.pcintegration.pc910.PCObjectConverterFactory()
