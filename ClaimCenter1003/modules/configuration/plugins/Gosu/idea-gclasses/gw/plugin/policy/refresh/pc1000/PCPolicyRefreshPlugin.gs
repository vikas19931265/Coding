 ...
 * the gw.plugin.pcintegration.pc1000.PolicySearchPCPlugin implementation for determining
...
class PCPolicyRefreshPlugin extends PolicyRefreshPluginBase {
   ...
   */
  construct() {
    super(new gw.plugin.policy.refresh.pc1000.PCPolicyRefreshConfiguration())
  }
