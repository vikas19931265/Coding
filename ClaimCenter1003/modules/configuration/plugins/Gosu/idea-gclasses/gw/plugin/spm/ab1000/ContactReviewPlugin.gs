...
uses wsi.remote.gw.webservice.ab.ab1000.abvendorevaluationapi.ABVendorEvaluationAPI
uses wsi.remote.gw.webservice.ab.ab1000.abvendorevaluationapi.types.complex.ABVendorEvaluationAPIReviewSummary
...
class ContactReviewPlugin implements IContactReviewPlugin, InitializablePlugin {
  ...
  override function submitReview(review: Review) : String {
    ...
    if (linkstatus.Linked and not linkstatus.Broken) {
      ...
      var categoryScore = new wsi.remote.gw.webservice.ab.ab1000.abvendorevaluationapi.anonymous.elements.ABVendorEvaluationAPIReviewSummary_CategoryScores()
      var category = new wsi.remote.gw.webservice.ab.ab1000.abvendorevaluationapi.anonymous.elements.ABVendorEvaluationAPIReviewSummary_ReviewCategories()
