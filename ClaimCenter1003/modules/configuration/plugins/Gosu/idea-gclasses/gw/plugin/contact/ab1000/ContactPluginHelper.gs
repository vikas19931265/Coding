...
uses wsi.remote.gw.webservice.ab.ab1000.abcontactapi.anonymous.elements.ABContactAPIFindDuplicatesResultContainer_Results_Entry
uses wsi.remote.gw.webservice.ab.ab1000.abcontactapi.anonymous.elements.ABContactAPISearchResultContainer_Results_Entry
uses wsi.remote.gw.webservice.ab.ab1000.abcontactapi.anonymous.elements.ABContactAPISearchSpec_SortColumns
uses wsi.remote.gw.webservice.ab.ab1000.abcontactapi.anonymous.elements.ABContactAPISearchSpec_SortColumns_Entry
uses wsi.remote.gw.webservice.ab.ab1000.abcontactapi.anonymous.elements.ABContactAPISearchSpec_SubtypeFilter
uses wsi.remote.gw.webservice.ab.ab1000.abcontactapi.types.complex.ABContactAPIFindDuplicatesResultContainer
uses wsi.remote.gw.webservice.ab.ab1000.abcontactapi.types.complex.ABContactAPIPendingContactChange
uses wsi.remote.gw.webservice.ab.ab1000.abcontactapi.types.complex.ABContactAPISearchResultContainer
...
internal class ContactPluginHelper extends ContactPluginHelperBase {
  ...
  private var _nameMapper : NameMapper as NameMapper = ContactIntegrationMapperFactory.mapper().NameMapper
  ...
  protected function toRemoteXmlBackedInstance(xmlContact : XmlBackedInstance) : wsi.remote.gw.webservice.ab.ab1000.beanmodel.XmlBackedInstance {
    return wsi.remote.gw.webservice.ab.ab1000.beanmodel.XmlBackedInstance.parse(xmlContact.bytes())
  }
  
  protected function fromRemoteXmlBackedInstance(remoteXmlInstance:wsi.remote.gw.webservice.ab.ab1000.beanmodel.XmlBackedInstance) : XmlBackedInstance {
 ...
 */
  ...
  protected function createContactContactWithRelationshipFromXML(xml : XmlBackedInstance, bundle : Bundle) : ContactContact {
    ...
    var xsdTypeName = mapper.NameMapper.getABEntityName(ContactContact.Type.RelativeName)
