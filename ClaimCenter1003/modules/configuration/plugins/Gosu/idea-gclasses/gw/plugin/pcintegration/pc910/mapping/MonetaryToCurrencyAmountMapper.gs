package gw.plugin.pcintegration.pc910.mapping
...
class MonetaryToCurrencyAmountMapper implements IFieldMapper {
  ...
  override function mapField(converter : ObjectConverter,
    ...
    if(not gw.api.util.TypeUtil.isNominallyOrStructurallyAssignable(CurrencyAmount.Type, targetProperty.FeatureType)) {
