...
class ClaimDocumentsExpressions {
  ...
  public static class ClaimDocumentsExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    static function canVisit_22 (Claim :  Claim) : java.lang.Boolean {
    ...
    static function parent_23 (Claim :  Claim) : pcf.api.Destination {
  ...
  public static class SearchPanelExpressionsImpl extends ClaimDocumentsExpressionsImpl {
    ...
    function def_onEnter_18 (def :  pcf.DocumentsLV) : void {
    ...
    // 'def' attribute on PanelRef at ClaimDocuments.pcf: line 45, column 66
    function def_refreshVariables_19 (def :  pcf.DocumentsLV) : void {
    ...
    function searchCriteria_21 () : entity.DocumentSearchCriteria {
