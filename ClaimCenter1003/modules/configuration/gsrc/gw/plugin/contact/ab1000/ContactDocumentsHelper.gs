...
uses wsi.remote.gw.webservice.ab.ab1000.abcontactapi.anonymous.elements.ABContactAPIDocumentSearchSpec_SortColumns
uses wsi.remote.gw.webservice.ab.ab1000.abcontactapi.anonymous.elements.ABContactAPIDocumentSearchSpec_SortColumns_Entry
uses wsi.remote.gw.webservice.ab.ab1000.abcontactapi.types.complex.ABContactAPIDocumentSearchResultContainer
uses wsi.remote.gw.webservice.ab.ab1000.abcontactapi.types.complex.ABContactAPIDocumentSearchSpec
...
class ContactDocumentsHelper {
  ...
  protected function toSearchResult(xmlSearchResult:ABContactAPIDocumentSearchResultContainer, countOnly:boolean) : ContactDocumentsSearchResult {
    ...
    return new ContactDocumentsSearchResult(xmlSearchResult.Results.Entry.map(\ sr -> {
      return ContactDocumentsSearchResultMapper.createContactDocumentInfoFromSearchResult(sr)
    }))
  }
