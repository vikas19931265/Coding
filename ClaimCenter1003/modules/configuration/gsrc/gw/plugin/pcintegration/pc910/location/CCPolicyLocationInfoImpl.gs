package gw.plugin.pcintegration.pc910.location

uses gw.api.upgrade.Coercions
uses gw.plugin.policy.location.CCPolicyLocationInfo
uses wsi.remote.gw.webservice.pc.pc910.entities.anonymous.elements.PolicyLocationInfo_PNIAddressFields
uses wsi.remote.gw.webservice.pc.pc910.entities.anonymous.elements.PolicyLocationInfo_PolicyLocationAddress
uses wsi.remote.gw.webservice.pc.pc910.entities.anonymous.elements.PolicyLocationInfo_TotalInsuredValues
uses wsi.remote.gw.webservice.pc.pc910.entities.types.complex.PolicyLocationInfo
...
class CCPolicyLocationInfoImpl implements CCPolicyLocationInfo {
  ...
  override property get PolicyLocationAddress(): CCPolicyLocationInfoImpl.Address {
    return new CCPolicyLocationInfoImpl.Address(_info.PolicyLocationAddress)
  }
  ...
  override property get TotalInsuredValues(): CCPolicyLocationInfoImpl.InsuredValue[] {
    return (_info.TotalInsuredValues.map(\insuredVal -> new CCPolicyLocationInfoImpl.InsuredValue(insuredVal)))?.toTypedArray()
  }
