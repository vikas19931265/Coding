...
class PCObjectConverterFactory {
  ...
  construct() {
    try {
      var pcToCcFile = Resources.PCTOCC_DATAMAPPING_PC910
      _pcToCCTranslator = new PolicyNameTranslatorImpl( pcToCcFile, "wsi.remote.gw.webservice.pc.pc910.entities.types.complex", "entity" )
    } catch( e : Throwable ) {
