...
class RIDataGenerator
{
  ...
  final function loadDemoData() {
    ...
    var key53235675Dwelling = new Pair<String,CoverageType>("73-235676", CoverageType.TC_HOPCOVA)
    ...
    var key53235675PerProp = new Pair<String,CoverageType>("73-235676", CoverageType.TC_HOPCOVC)
