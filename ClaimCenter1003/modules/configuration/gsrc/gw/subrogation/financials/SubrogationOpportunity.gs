...
class SubrogationOpportunity {
  ...
  static function determineEligibility(claim : Claim) : boolean {
    ...
    switch (claim.LossType) {
      case LOBAbstraction.ForClaim.ForLossType.Auto:
      ...
      case LOBAbstraction.ForClaim.ForLossType.Property:
        switch (claim.LossCause) {
      ...
      case LOBAbstraction.ForClaim.ForLossType.GeneralLiability:
        switch (claim.LossCause) {
          case TC_PRODUCT:
      ...
      case LOBAbstraction.ForClaim.ForLossType.WorkComp:
