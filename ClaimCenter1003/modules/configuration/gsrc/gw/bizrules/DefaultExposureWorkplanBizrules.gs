...
uses gw.api.databuilder.bizrules.activity.ActivityRuleUpdateBuilder
...
/**
 * Builders to create the Exposure Activity Rules
 */
@Export
class DefaultExposureWorkplanBizrules extends DefaultAbstractBizrulesBase {
  ...
  private static function createEXW07100Rule() {
    var head = new ActivityRuleHeadBuilder()
        ...
        .withRule(new ActivityRuleBuilder()
            ...
            .withTriggeringPointKey(TriggeringPointKey.TC_CREATION)
            .withRuleCondition(new RuleConditionBuilder()
                .addRuleConditionLine("claim.Policy.PolicyType", RuleOperator.TC_EQUALS, ExpressionFragmentBuilders.forTypeKeyExpression(PolicyType.TC_HOPHOMEOWNERS))
                ...
                .addRuleConditionLine("exposure.CoverageSubType", RuleOperator.TC_EQUALS, ExpressionFragmentBuilders.forTypeKeyExpression(CoverageSubtype.TC_HOPCOVC)))
    ...
    var head2 = new ActivityRuleUpdateBuilder(head)
        .withRule(new ActivityRuleBuilder()
            ...
            .withRuleCondition(new RuleConditionBuilder()
                ...
                .addRuleConditionLine("exposure.ExposureType", RuleOperator.TC_EQUALS, ExpressionFragmentBuilders.forTypeKeyExpression(ExposureType.TC_CONTENT))
                .addTrueFalseRuleConditionLine("exposure.Claim.Policy.HomeownersPolicy", RuleOperator.TC_ISTRUE)
                .addTrueFalseRuleConditionLine("exposure.HomeownersPersonalPropertyCoverageSubtype", RuleOperator.TC_ISTRUE))
            .addRuleCommandDefinition(new GenerateActivityCommandDefinitionBuilder("damaged_items")
                .withExposureContextParameter()
                .withRelatedTo(ExposureRelatedTo.NAME)
                .withAssignedTo(ExposureOwnerActivityAssigneeLoader.NAME)
        ...
        .withRule(new ActivityRuleBuilder()
            ...
            .withRuleCondition(new RuleConditionBuilder()
                ...
                .addRuleConditionLine(new RuleConditionLineBuilder()
                    ...
                    .withRightOperand(ExpressionFragmentBuilders.forTypeKeyExpression(CoverageSubtype.TC_HOPCOVEPD))))
        ...
        .withRule(new ActivityRuleBuilder()
            ...
            .withRuleCondition(new RuleConditionBuilder()
                ...
                .addRuleConditionLine(new RuleConditionLineBuilder()
                    .withLineNumber(4)
                    .withBooleanOperator(RuleBooleanOperator.TC_AND)
                    .withLeftOperand("exposure.HomeownersPersonalLiabilityCoverageSubtype")
