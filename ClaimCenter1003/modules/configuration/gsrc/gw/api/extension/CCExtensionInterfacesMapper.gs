...
class CCExtensionInterfacesMapper implements ExtensionInterfacesMapper {
  ...
  override function bindImplementations(config: ExtensionInterfacesConfig) {
    ...
    config.setImplementation<IContactIntegrationMapperFactoryExtensions_AB1000>(new IContactIntegrationMapperFactoryExtensions_AB1000() {
      override function mapper(): gw.contactmapper.ab1000.ContactIntegrationMapper {
        return gw.contactmapper.ab1000.ContactIntegrationMapperFactory.mapper()
      }
    })

    config.setImplementation<ICCNameMapperExtensions_AB1000>(new ICCNameMapperExtensions_AB1000() {
      override property get Instance(): NameMapper {
        return gw.contactmapper.ab1000.CCNameMapper.Instance
      }
    })
