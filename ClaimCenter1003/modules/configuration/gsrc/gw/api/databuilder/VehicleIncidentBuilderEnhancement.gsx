...
enhancement VehicleIncidentBuilderEnhancement : VehicleIncidentBuilder {
  ...
  /**
   * Returns builder after setting LossParty to the given value
   * @deprecated Use {@link #withLossParty(LossPartyType)} instead
   */
  @Deprecated("Use #withLossParty(LossPartyType) instead")
  function withVehicleLossParty(vehicleLossParty : LossPartyType) : VehicleIncidentBuilder {
    this.set(VehicleIncident#LossParty, vehicleLossParty)
    return this
  }

  function withLossParty(lossParty : LossPartyType) : VehicleIncidentBuilder {
    this.set(VehicleIncident#LossParty, lossParty)
    return this
  }
