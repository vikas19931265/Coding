...
class CSPlugin extends BaseCommand {
  ...
  @Argument("impl", { CSPlugin.AB900_PLUGIN, CSPlugin.AB1000_PLUGIN, CSPlugin.UNAVAILABLE_PLUGIN, CSPlugin.DEMO_PLUGIN, CSPlugin.DISABLED_PLUGIN, CSPlugin._default, CSPlugin._reset})
