 ...
 */
@Export
@WsiExportable("http://guidewire.com/cc/ws/gw/webservice/cc/cc904/dto/ActivityPatternDTO")
final class ActivityPatternDTO {
   ...
   * @param bundleProvider The entity in whose Bundle to create the new ActivityPattern.
   ...
   */
  final function writeToNewEntityIn(bundleProvider: BundleProvider, createNew: block(): ActivityPattern = null, ignoreNullValues = true): ActivityPattern {
