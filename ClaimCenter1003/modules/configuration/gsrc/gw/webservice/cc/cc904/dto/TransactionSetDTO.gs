 ...
 * A {@link TransactionSetDTO} is a DTO that represents an instance of {@link entity.TransactionSet} for use by certain WS-I Web Services in the base product. This file is composed of basic getters and setters, plus members that make it easier for server-side code to work with DTOs, like virtual getters that query for entities by PublicID, and methods to copy fields to or from an instance of {@link entity.TransactionSet}.
...
final class TransactionSetDTO {
   ...
   */
  final function writeTo<T extends TransactionSet>(that: T, ignoreNullValues = true): T {
    // if field is on base class
   ...
   * @param bundleProvider The entity in whose Bundle to create the new TransactionSet.
   ...
   */
  final function writeToNewEntityIn<T extends TransactionSet>(bundleProvider: BundleProvider, createNew: block(): T = null, ignoreNullValues = true): T {
    var instance: T
