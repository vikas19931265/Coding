 ...
 * An {@link IncidentDTO} is a DTO that represents an instance of {@link entity.Incident} for use by certain WS-I Web Services in the base product. This file is composed of basic getters and setters, plus members that make it easier for server-side code to work with DTOs, like virtual getters that query for entities by PublicID, and methods to copy fields to or from an instance of {@link entity.Incident}.
 ...
 * <table border="1"><tr><th>Field</th><th>Maps to</th></tr><tr><td>AmbulanceUsed</td><td>InjuryIncident.AmbulanceUsed</td></tr><tr><td>ClaimPublicID</td><td>Incident.Claim.PublicID</td></tr><tr><td>CreateTime</td><td>Incident.CreateTime</td></tr><tr><td>CreateUserPublicID</td><td>Incident.CreateUser.PublicID</td></tr><tr><td>Description</td><td>Incident.Description</td></tr><tr><td>DetailedInjuryType</td><td>InjuryIncident.DetailedInjuryType</td></tr><tr><td>DisabledDueToAccident</td><td>InjuryIncident.DisabledDueToAccident</td></tr><tr><td>driverPublicID</td><td>VehicleIncident.driver.PublicID</td></tr><tr><td>ExposurePublicIDs</td><td>Incident.Exposures*.PublicID</td></tr><tr><td>GeneralInjuryType</td><td>InjuryIncident.GeneralInjuryType</td></tr><tr><td>injuredPublicID</td><td>InjuryIncident.injured.PublicID</td></tr><tr><td>LocationAddressPublicID</td><td>MobilePropertyIncident.LocationAddress.PublicID</td></tr><tr><td>LossDesc</td><td>MobilePropertyIncident.LossDesc</td></tr><tr><td>LossOccured</td><td>MobilePropertyIncident.LossOccured</td></tr><tr><td>LossofUse</td><td>PropertyIncident.LossofUse</td></tr><tr><td>MedicalTreatmentType</td><td>InjuryIncident.MedicalTreatmentType</td></tr><tr><td>PropertyDesc</td><td>PropertyIncident.PropertyDesc</td></tr><tr><td>PropertyPublicID</td><td>FixedPropertyIncident.Property.PublicID</td></tr><tr><td>PublicID</td><td>Incident.PublicID</td></tr><tr><td>Severity</td><td>Incident.Severity</td></tr><tr><td>Subtype</td><td>Incident.Subtype</td></tr><tr><td>TypeofPropertyPublicIDs</td><td>PropertyIncident.TypeofProperty*.PublicID</td></tr><tr><td>UpdateTime</td><td>Incident.UpdateTime</td></tr><tr><td>UpdateUserPublicID</td><td>Incident.UpdateUser.PublicID</td></tr><tr><td>VehiclePublicID</td><td>VehicleIncident.Vehicle.PublicID</td></tr></table></p>
 */
@Export
@WsiExportable("http://guidewire.com/cc/ws/gw/webservice/cc/cc904/dto/IncidentDTO")
final class IncidentDTO {
  ...
  /** Derived from FixedPropertyIncident#Property.PublicID */
  ...
  final function readFrom(that: Incident): IncidentDTO {
    ...
    //
    if (that typeis FixedPropertyIncident) {
   ...
   */
  reified function writeTo<T extends Incident>(that: T, ignoreNullValues = true): T {
    // if field is on base class
   ...
   * @param bundleProvider The entity in whose Bundle to create the new Incident.
   ...
   */
  reified function writeToNewEntityIn<T extends Incident>(bundleProvider: BundleProvider, createNew: block(): T = null, ignoreNullValues = true): T {
    var instance: T
