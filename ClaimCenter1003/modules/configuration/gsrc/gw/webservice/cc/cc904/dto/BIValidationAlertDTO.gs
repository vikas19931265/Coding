 ...
 */
@Export
@WsiExportable("http://guidewire.com/cc/ws/gw/webservice/cc/cc904/dto/BIValidationAlertDTO")
final class BIValidationAlertDTO {
   ...
   * @param bundleProvider The entity in whose Bundle to create the new BIValidationAlert.
   ...
   */
  final function writeToNewEntityIn(bundleProvider: BundleProvider, createNew: block(): BIValidationAlert = null, ignoreNullValues = true): BIValidationAlert {
