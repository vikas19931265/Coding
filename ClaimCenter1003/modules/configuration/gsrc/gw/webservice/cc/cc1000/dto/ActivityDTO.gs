 ...
 * An {@link gw.webservice.cc.cc1000.dto.ActivityDTO} is a DTO that represents an instance of {@link entity.Activity} for use by certain WS-I Web Services in the base product. This file is composed of basic getters and setters, plus members that make it easier for server-side code to work with DTOs, like virtual getters that query for entities by PublicID, and methods to copy fields to or from an instance of {@link entity.Activity}.
 ...
 * <p>The specific mappings for {@link gw.webservice.cc.cc1000.dto.ActivityDTO} are as follows:
 ...
 */
@Export
@WsiExportable("http://guidewire.com/cc/ws/gw/webservice/cc/cc1000/dto/ActivityDTO")
final class ActivityDTO {
   ...
   * @param bundleProvider The entity in whose Bundle to create the new Activity.
   ...
   */
  final function writeToNewEntityIn(bundleProvider: BundleProvider, createNew: block(): Activity = null, ignoreNullValues = true): Activity {
