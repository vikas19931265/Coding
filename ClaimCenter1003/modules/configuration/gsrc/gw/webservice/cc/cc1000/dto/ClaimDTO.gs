 ...
 * <p>The specific mappings for {@link gw.webservice.cc.cc1000.dto.ClaimDTO} are as follows:
 ...
 */
@Export
@WsiExportable("http://guidewire.com/cc/ws/gw/webservice/cc/cc1000/dto/ClaimDTO")
final class ClaimDTO {
  ...
  var _newClaimant               : ContactDTO           as NewClaimant
   ...
   * @param bundleProvider The entity in whose Bundle to create the new Claim.
   ...
   */
  final function writeToNewEntityIn(bundleProvider: BundleProvider, createNew: block(): Claim = null, ignoreNullValues = true): Claim {
    var instance: Claim
