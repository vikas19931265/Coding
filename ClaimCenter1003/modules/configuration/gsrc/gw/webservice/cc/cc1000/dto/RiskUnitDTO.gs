 ...
 */
@Export
@WsiExportable("http://guidewire.com/cc/ws/gw/webservice/cc/cc1000/dto/RiskUnitDTO")
final class RiskUnitDTO {
   ...
   */
  reified function writeTo<T extends RiskUnit>(that: T, ignoreNullValues = true): T {
    // if field is on base class
   ...
   */
  reified function writeToNewEntityIn<T extends RiskUnit>(bundleProvider: BundleProvider, createNew: block(): T = null, ignoreNullValues = true): T {
    var instance: T
