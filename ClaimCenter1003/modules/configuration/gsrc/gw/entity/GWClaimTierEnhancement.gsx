...
enhancement GWClaimTierEnhancement : entity.Claim {
  ...
  function setClaimTier() : void {
    ...
    if (LOBAbstraction.ForPolicy.isWorkersCompPolicy(this.Claim.Policy)) {
  ...
  property get IsVeryComplexProperty() : boolean {
    return LOBAbstraction.ForClaim.ForLossType.isProperty(this) and this.LossCause == TC_FIRE and
            (not LOBAbstraction.ForPolicy.isHomeownersPolicy(this.Policy)
  ...
  property get IsComplexProperty() : boolean {
    return LOBAbstraction.ForClaim.ForLossType.isProperty(this)
