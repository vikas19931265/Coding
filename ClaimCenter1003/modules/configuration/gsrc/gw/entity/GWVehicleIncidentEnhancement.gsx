...
enhancement GWVehicleIncidentEnhancement : entity.VehicleIncident {
  ...
  /**
   * Returns LossParty from superclass Incident.
   * This is to provide backwards compatibility for customers who are using VehicleLossParty.
   *
   * @deprecated Use {@link Incident#getLossParty()} instead
   */
  @Deprecated("Use Incident#getLossParty() instead")
  property get VehicleLossParty(): LossPartyType {
    return this.LossParty
  }

  /**
   * Sets LossParty from superclass Incident.
   * This is to provide backwards compatibility for customers who are using VehicleLossParty.
   *
   * @deprecated Use {@link Incident#setLossParty(typekey.LossPartyType)} instead
   */
  @Deprecated("Use Incident#setLossParty(typekey.LossPartyType) instead")
  property set VehicleLossParty(vehicleLossParty: LossPartyType) {
    this.LossParty = vehicleLossParty
  }
}
