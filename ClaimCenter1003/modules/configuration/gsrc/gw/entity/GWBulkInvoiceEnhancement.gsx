...
enhancement GWBulkInvoiceEnhancement : entity.BulkInvoice {
  ...
  property get FailedOperationMessage() : String {
    switch (this.FailedOperation) {
      case BulkInvoiceStatus.TC_PROCESSINGDELETE:
        return DisplayKey.get("Web.Financials.BulkPay.Invoice.ErrorDuringProcessing.Deleting")
      case BulkInvoiceStatus.TC_PROCESSINGSTOP:
        return DisplayKey.get("Web.Financials.BulkPay.Invoice.ErrorDuringProcessing.Stopping")
      case BulkInvoiceStatus.TC_PROCESSINGVOID:
        return DisplayKey.get("Web.Financials.BulkPay.Invoice.ErrorDuringProcessing.Voiding")
      default:
        return DisplayKey.get("Web.Financials.BulkPay.Invoice.ErrorDuringProcessing")
    }
  }
}
