          ...
          .withRiskUnit( new gw.api.databuilder.GeneralLiabilityRUBuilder()
            ...
            .withPolicyLocation(policyLocationDemoSample301)
                .withCoverage(new gw.api.databuilder.PropertyCoverageBuilder()
                    ...
                    .withType(TC_PRODUCTWITHDRAWALLTD)
                    .withCovTerm(new FinancialCovTermBuilder()
                        .withCovTermPattern(CovTermPattern.TC_PRODUCTWITHDRAWDEDUCT)
            ...
            .withRiskUnit(new gw.api.databuilder.GeneralLiabilityRUBuilder()
                ...
                .withCoverage(new gw.api.databuilder.PropertyCoverageBuilder()
                    .withIncidentLimit(25000bd.ofDefaultCurrency())
                    .withType(TC_GLEMPBENEFITSLIABILITYCOV)
                    .withCovTerm(new FinancialCovTermBuilder()
                        .withCovTermPattern(CovTermPattern.TC_GLEMPBENEFITSLIABDEDUCT)
                        .withFinancialAmount(500bd))))
